...
```bash
terraform import scm_anti_spyware_profile.example folder:::id
```

or

```bash
terraform import scm_anti_spyware_profile.example :snippet::id
```

or

```bash
terraform import scm_anti_spyware_profile.example ::device:id
```
