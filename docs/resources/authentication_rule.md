...
```bash
terraform import scm_authentication_rule.example folder:::id
```

or

```bash
terraform import scm_authentication_rule.example :snippet::id
```

or

```bash
terraform import scm_authentication_rule.example ::device:id
```
