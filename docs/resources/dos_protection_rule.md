...
```bash
terraform import scm_dos_protection_rule.example folder:::id
```

or

```bash
terraform import scm_dos_protection_rule.example :snippet::id
```

or

```bash
terraform import scm_dos_protection_rule.example ::device:id
```
