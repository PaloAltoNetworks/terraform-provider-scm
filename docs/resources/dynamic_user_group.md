...
```bash
terraform import scm_dynamic_user_group.example folder:::id
```

or

```bash
terraform import scm_dynamic_user_group.example :snippet::id
```

or

```bash
terraform import scm_dynamic_user_group.example ::device:id
```
