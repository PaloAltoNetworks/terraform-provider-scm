...
~> **Note:** You must specify at most one of `ipv4` or `ipv6`.
...
~> **Note:** You must specify at most one of `fqdn` or `ip`.
...
~> **Note:** You must specify at most one of `ebgp_confed`, `ebgp`, `ibgp_confed` or `ibgp`.
...
~> **Note:** You must specify at most one of `none`, `prepend`, `remove_and_prepend` or `remove`.
...
~> **Note:** You must specify at most one of `append`, `none`, `overwrite`, `remove_all` or `remove_regex`.
...
~> **Note:** You must specify at most one of `allow` or `deny`.
...
~> **Note:** You must specify at most one of `balanced_round_robin`, `ip_hash`, `ip_modulo` or `weighted_round_robin`.
...
~> **Note:** You must specify at most one of `candidate_rp` or `static_rp`.
...
~> **Note:** You must specify at most one of `broadcast`, `p2mp` or `p2p`.
...
~> **Note:** You must specify at most one of `normal`, `nssa` or `stub`.
...
~> **Note:** You must specify at most one of `advertise` or `disable`.
...
~> **Note:** You must specify at most one of `md5`, `sha1`, `sha256`, `sha384` or `sha512`.
...
~> **Note:** You must specify at most one of `md5`, `none`, `sha1`, `sha256`, `sha384` or `sha512`.
...
~> **Note:** You must specify at most one of `discard`, `fqdn`, `ip_address`, `ipv6_address`, `next_lr`, `next_vr`, `receive` or `tunnel`.
...
~> **Note:** You must specify at most one of `both`, `multicast`, `no_install` or `unicast`.
...
~> **Note:** You must specify at most one of `discard`, `fqdn`, `ipv6_address`, `next_lr`, `next_vr`, `receive` or `tunnel`.
...
```bash
terraform import scm_logical_router.example folder:::id
```

or

```bash
terraform import scm_logical_router.example :snippet::id
```

or

```bash
terraform import scm_logical_router.example ::device:id
```
