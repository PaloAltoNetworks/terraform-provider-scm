...
```bash
terraform import scm_route_access_list.example folder:::id
```

or

```bash
terraform import scm_route_access_list.example :snippet::id
```

or

```bash
terraform import scm_route_access_list.example ::device:id
```
