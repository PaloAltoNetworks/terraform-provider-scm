...
func (a *SnippetSnapshotUpdatesAction) Metadata(_ context.Context, _ action.MetadataRequest, resp *action.MetadataResponse) {
	resp.TypeName = "scm_snippet_snapshot_updates"
}
