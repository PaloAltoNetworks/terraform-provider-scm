...
var (
	_ datasource.DataSource              = &SnippetCategoryListDataSource{}
	_ datasource.DataSourceWithConfigure = &SnippetCategoryListDataSource{}
)

func NewSnippetCategoryListDataSource() datasource.DataSource {
	return &SnippetCategoryListDataSource{}
}

// SnippetCategoryListDataSource defines the data source implementation.
type SnippetCategoryListDataSource struct {
	client *config_setup.APIClient
}

func (d *SnippetCategoryListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_snippet_category_list"
}

func (d *SnippetCategoryListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SnippetCategoriesListDataSourceSchema
}

func (d *SnippetCategoryListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SnippetCategoryListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SnippetCategoriesListModel
	...
	packedList, diags := packSnippetCategoriesListFromSdk(ctx, listResponse.GetData())
