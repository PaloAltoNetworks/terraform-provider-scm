...
// SnippetListDataSource defines the data source implementation.
...
func (d *SnippetListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SnippetsListDataSourceSchema
}

func (d *SnippetListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SnippetListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SnippetsListModel
	...
	packedList, diags := packSnippetsListFromSdk(ctx, listResponse.GetData())
