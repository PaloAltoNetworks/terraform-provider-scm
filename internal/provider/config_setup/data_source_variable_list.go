...
// VariableListDataSource defines the data source implementation.
...
func (d *VariableListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.VariablesListDataSourceSchema
}

func (d *VariableListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *VariableListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.VariablesListModel
	...
	packedList, diags := packVariablesListFromSdk(ctx, listResponse.GetData())
