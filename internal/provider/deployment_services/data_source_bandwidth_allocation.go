...
// DATA SOURCE for SCM BandwidthAllocation (Package: deployment_services)
var (
...
// BandwidthAllocationDataSource defines the data source implementation.
...
func (d *BandwidthAllocationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "--- ENTER: BandwidthAllocationDataSource.Metadata ---")
...
func (d *BandwidthAllocationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "--- ENTER: BandwidthAllocationDataSource.Schema ---")
...
func (d *BandwidthAllocationDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "--- ENTER: BandwidthAllocationsDataSource.Configure ---")
...
func (d *BandwidthAllocationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "--- ENTER: BandwidthAllocationDataSource.Read ---")
	...
	if !data.Id.IsNull() {
		...
		tflog.Debug(ctx, "Reading BandwidthAllocations data source by ID", map[string]interface{}{"id": objectId})

		getReq := d.client.BandwidthAllocationsAPI.(ctx, objectId)
