...
// InternalDnsServerListDataSource defines the data source implementation.
...
func (d *InternalDnsServerListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.InternalDnsServersListDataSourceSchema
}

func (d *InternalDnsServerListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InternalDnsServerListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.InternalDnsServersListModel
	...
	packedList, diags := packInternalDnsServersListFromSdk(ctx, listResponse.GetData())
