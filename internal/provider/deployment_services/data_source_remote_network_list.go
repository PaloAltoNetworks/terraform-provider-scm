...
// RemoteNetworkListDataSource defines the data source implementation.
...
func (d *RemoteNetworkListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RemoteNetworksListDataSourceSchema
}

func (d *RemoteNetworkListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RemoteNetworkListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RemoteNetworksListModel
	...
	packedList, diags := packRemoteNetworksListFromSdk(ctx, listResponse.GetData())
