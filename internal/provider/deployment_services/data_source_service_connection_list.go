...
// ServiceConnectionListDataSource defines the data source implementation.
type ServiceConnectionListDataSource struct {
	client *deployment_services.APIClient
}

func (d *ServiceConnectionListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_service_connection_list"
}

func (d *ServiceConnectionListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ServiceConnectionsListDataSourceSchema
}

func (d *ServiceConnectionListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ServiceConnectionListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ServiceConnectionsListModel
	...
	packedList, diags := packServiceConnectionsListFromSdk(ctx, listResponse.GetData())
