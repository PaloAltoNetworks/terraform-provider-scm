...
var (
	_ datasource.DataSource              = &SharedInfrastructureSettingListDataSource{}
	_ datasource.DataSourceWithConfigure = &SharedInfrastructureSettingListDataSource{}
)

func NewSharedInfrastructureSettingListDataSource() datasource.DataSource {
	return &SharedInfrastructureSettingListDataSource{}
}

// SharedInfrastructureSettingListDataSource defines the data source implementation.
type SharedInfrastructureSettingListDataSource struct {
	client *deployment_services.APIClient
}

func (d *SharedInfrastructureSettingListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_shared_infrastructure_setting_list"
}

func (d *SharedInfrastructureSettingListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SharedInfrastructureSettingsListDataSourceSchema
}

func (d *SharedInfrastructureSettingListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SharedInfrastructureSettingListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SharedInfrastructureSettingsListModel
	...
	listReq := d.client.SharedInfrastructureSettingsAPI.GetSharedInfrastructureSettings(ctx)
	...
	packedList, diags := packSharedInfrastructureSettingsListFromSdk(ctx, listResponse.GetData())
