...
// SiteListDataSource defines the data source implementation.
...
func (d *SiteListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SitesListDataSourceSchema
}

func (d *SiteListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SiteListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SitesListModel
	...
	packedList, diags := packSitesListFromSdk(ctx, listResponse.GetData())
