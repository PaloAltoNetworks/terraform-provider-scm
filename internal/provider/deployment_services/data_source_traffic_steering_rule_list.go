...
// TrafficSteeringRuleListDataSource defines the data source implementation.
...
func (d *TrafficSteeringRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.TrafficSteeringRulesListDataSourceSchema
}

func (d *TrafficSteeringRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *TrafficSteeringRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.TrafficSteeringRulesListModel
	...
	packedList, diags := packTrafficSteeringRulesListFromSdk(ctx, listResponse.GetData())
