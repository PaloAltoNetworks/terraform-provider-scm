...
// RESOURCE for SCM BandwidthAllocation (Package: deployment_services)
var (
...
func (r *BandwidthAllocationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Debug(ctx, "Updating bandwidth_allocations on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.BandwidthAllocationsAPI.UpdateBandwidthAllocations(ctx, objectId).BandwidthAllocations(*unpackedScmObject)
...
func (r *BandwidthAllocationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Debug(ctx, "Deleting bandwidth_allocations", map[string]interface{}{"id": objectId})
	deleteReq := r.client.BandwidthAllocationsAPI.DeleteBandwidthAllocations(ctx, objectId)
