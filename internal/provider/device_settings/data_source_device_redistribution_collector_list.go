...
var (
	_ datasource.DataSource              = &DeviceRedistributionCollectorListDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceRedistributionCollectorListDataSource{}
)

func NewDeviceRedistributionCollectorListDataSource() datasource.DataSource {
	return &DeviceRedistributionCollectorListDataSource{}
}

// DeviceRedistributionCollectorListDataSource defines the data source implementation.
type DeviceRedistributionCollectorListDataSource struct {
...
func (d *DeviceRedistributionCollectorListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DeviceRedistributionCollectorListDataSourceSchema
}

func (d *DeviceRedistributionCollectorListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DeviceRedistributionCollectorListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DeviceRedistributionCollectorListModel
	...
	listReq := d.client.DeviceRedistributionCollectorSettingsAPI.ListDeviceRedistributionCollectorSettings(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing DeviceRedistributionCollectors", fmt.Sprintf("Could not list DeviceRedistributionCollectors: %s", err.Error()))
