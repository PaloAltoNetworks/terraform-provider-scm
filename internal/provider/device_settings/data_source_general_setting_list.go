...
var (
	_ datasource.DataSource              = &GeneralSettingListDataSource{}
	_ datasource.DataSourceWithConfigure = &GeneralSettingListDataSource{}
)

func NewGeneralSettingListDataSource() datasource.DataSource {
	return &GeneralSettingListDataSource{}
}

// GeneralSettingListDataSource defines the data source implementation.
type GeneralSettingListDataSource struct {
...
func (d *GeneralSettingListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.GeneralSettingsListDataSourceSchema
}

func (d *GeneralSettingListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *GeneralSettingListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.GeneralSettingsListModel
	...
	listReq := d.client.GeneralSettingsAPI.ListGeneralSettings(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing GeneralSettingss", fmt.Sprintf("Could not list GeneralSettingss: %s", err.Error()))
	...
	packedList, diags := packGeneralSettingsListFromSdk(ctx, listResponse.GetData())
