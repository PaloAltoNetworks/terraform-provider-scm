...
var (
	_ datasource.DataSource              = &ServiceSettingListDataSource{}
	_ datasource.DataSourceWithConfigure = &ServiceSettingListDataSource{}
)

func NewServiceSettingListDataSource() datasource.DataSource {
	return &ServiceSettingListDataSource{}
}

// ServiceSettingListDataSource defines the data source implementation.
type ServiceSettingListDataSource struct {
...
func (d *ServiceSettingListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ServiceSettingsListDataSourceSchema
}

func (d *ServiceSettingListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ServiceSettingListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ServiceSettingsListModel
	...
	listReq := d.client.ServiceSettingsAPI.ListServiceSettings(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing ServiceSettingss", fmt.Sprintf("Could not list ServiceSettingss: %s", err.Error()))
	...
	packedList, diags := packServiceSettingsListFromSdk(ctx, listResponse.GetData())
