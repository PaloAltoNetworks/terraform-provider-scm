...
var (
	_ datasource.DataSource              = &UpdateScheduleListDataSource{}
	_ datasource.DataSourceWithConfigure = &UpdateScheduleListDataSource{}
)

func NewUpdateScheduleListDataSource() datasource.DataSource {
	return &UpdateScheduleListDataSource{}
}

// UpdateScheduleListDataSource defines the data source implementation.
type UpdateScheduleListDataSource struct {
...
func (d *UpdateScheduleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.UpdateScheduleListDataSourceSchema
}

func (d *UpdateScheduleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *UpdateScheduleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.UpdateScheduleListModel
	...
	listReq := d.client.UpdateScheduleSettingsAPI.ListUpdateScheduleSettings(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing UpdateSchedules", fmt.Sprintf("Could not list UpdateSchedules: %s", err.Error()))
	...
	packedList, diags := packUpdateScheduleListFromSdk(ctx, listResponse.GetData())
