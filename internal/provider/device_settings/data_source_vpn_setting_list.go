...
var (
	_ datasource.DataSource              = &VpnSettingListDataSource{}
	_ datasource.DataSourceWithConfigure = &VpnSettingListDataSource{}
)

func NewVpnSettingListDataSource() datasource.DataSource {
	return &VpnSettingListDataSource{}
}

// VpnSettingListDataSource defines the data source implementation.
type VpnSettingListDataSource struct {
...
func (d *VpnSettingListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.VpnSettingsListDataSourceSchema
}

func (d *VpnSettingListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *VpnSettingListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.VpnSettingsListModel
	...
	listReq := d.client.VPNSettingsAPI.ListVPNSettings(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing VpnSettingss", fmt.Sprintf("Could not list VpnSettingss: %s", err.Error()))
	...
	packedList, diags := packVpnSettingsListFromSdk(ctx, listResponse.GetData())
