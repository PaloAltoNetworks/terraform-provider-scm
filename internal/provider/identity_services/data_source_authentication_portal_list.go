...
// AuthenticationPortalListDataSource defines the data source implementation.
...
func (d *AuthenticationPortalListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AuthenticationPortalsListDataSourceSchema
}

func (d *AuthenticationPortalListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AuthenticationPortalListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AuthenticationPortalsListModel
	...
	packedList, diags := packAuthenticationPortalsListFromSdk(ctx, listResponse.GetData())
