...
// AuthenticationProfileListDataSource defines the data source implementation.
...
func (d *AuthenticationProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AuthenticationProfilesListDataSourceSchema
}

func (d *AuthenticationProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AuthenticationProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AuthenticationProfilesListModel
	...
	packedList, diags := packAuthenticationProfilesListFromSdk(ctx, listResponse.GetData())
