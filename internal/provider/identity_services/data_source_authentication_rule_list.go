...
// AuthenticationRuleListDataSource defines the data source implementation.
...
func (d *AuthenticationRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AuthenticationRulesListDataSourceSchema
}

func (d *AuthenticationRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AuthenticationRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AuthenticationRulesListModel
	...
	packedList, diags := packAuthenticationRulesListFromSdk(ctx, listResponse.GetData())
