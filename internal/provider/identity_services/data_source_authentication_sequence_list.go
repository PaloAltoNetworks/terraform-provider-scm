...
var (
	_ datasource.DataSource              = &AuthenticationSequenceListDataSource{}
	_ datasource.DataSourceWithConfigure = &AuthenticationSequenceListDataSource{}
)

func NewAuthenticationSequenceListDataSource() datasource.DataSource {
	return &AuthenticationSequenceListDataSource{}
}

// AuthenticationSequenceListDataSource defines the data source implementation.
type AuthenticationSequenceListDataSource struct {
	client *identity_services.APIClient
}

func (d *AuthenticationSequenceListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_authentication_sequence_list"
}

func (d *AuthenticationSequenceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AuthenticationSequencesListDataSourceSchema
}

func (d *AuthenticationSequenceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AuthenticationSequenceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AuthenticationSequencesListModel
	...
	packedList, diags := packAuthenticationSequencesListFromSdk(ctx, listResponse.GetData())
