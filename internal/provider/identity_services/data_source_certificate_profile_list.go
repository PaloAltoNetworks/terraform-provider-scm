...
// CertificateProfileListDataSource defines the data source implementation.
...
func (d *CertificateProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.CertificateProfilesListDataSourceSchema
}

func (d *CertificateProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CertificateProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.CertificateProfilesListModel
	...
	packedList, diags := packCertificateProfilesListFromSdk(ctx, listResponse.GetData())
