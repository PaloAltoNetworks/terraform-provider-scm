...
// KerberosServerProfileListDataSource defines the data source implementation.
...
func (d *KerberosServerProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.KerberosServerProfilesListDataSourceSchema
}

func (d *KerberosServerProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *KerberosServerProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.KerberosServerProfilesListModel
	...
	packedList, diags := packKerberosServerProfilesListFromSdk(ctx, listResponse.GetData())
