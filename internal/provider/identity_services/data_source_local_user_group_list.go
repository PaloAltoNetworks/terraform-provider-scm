...
// LocalUserGroupListDataSource defines the data source implementation.
type LocalUserGroupListDataSource struct {
	client *identity_services.APIClient
}

func (d *LocalUserGroupListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_local_user_group_list"
}

func (d *LocalUserGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LocalUserGroupsListDataSourceSchema
}

func (d *LocalUserGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LocalUserGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LocalUserGroupsListModel
	...
	packedList, diags := packLocalUserGroupsListFromSdk(ctx, listResponse.GetData())
