...
// LocalUserListDataSource defines the data source implementation.
...
func (d *LocalUserListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LocalUsersListDataSourceSchema
}

func (d *LocalUserListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LocalUserListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LocalUsersListModel
	...
	packedList, diags := packLocalUsersListFromSdk(ctx, listResponse.GetData())
