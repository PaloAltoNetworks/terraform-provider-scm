...
var (
	_ datasource.DataSource              = &MfaServerListDataSource{}
	_ datasource.DataSourceWithConfigure = &MfaServerListDataSource{}
)

func NewMfaServerListDataSource() datasource.DataSource {
	return &MfaServerListDataSource{}
}

// MfaServerListDataSource defines the data source implementation.
type MfaServerListDataSource struct {
...
func (d *MfaServerListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.MfaServersListDataSourceSchema
}

func (d *MfaServerListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *MfaServerListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.MfaServersListModel
	...
	packedList, diags := packMfaServersListFromSdk(ctx, listResponse.GetData())
