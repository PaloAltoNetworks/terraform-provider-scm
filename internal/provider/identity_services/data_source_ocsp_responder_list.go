...
// OcspResponderListDataSource defines the data source implementation.
...
func (d *OcspResponderListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.OcspRespondersListDataSourceSchema
}

func (d *OcspResponderListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *OcspResponderListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.OcspRespondersListModel
	...
	packedList, diags := packOcspRespondersListFromSdk(ctx, listResponse.GetData())
