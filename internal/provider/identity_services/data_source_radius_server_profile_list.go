...
// RadiusServerProfileListDataSource defines the data source implementation.
...
func (d *RadiusServerProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RadiusServerProfilesListDataSourceSchema
}

func (d *RadiusServerProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RadiusServerProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RadiusServerProfilesListModel
	...
	packedList, diags := packRadiusServerProfilesListFromSdk(ctx, listResponse.GetData())
