...
// SamlServerProfileListDataSource defines the data source implementation.
...
func (d *SamlServerProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SamlServerProfilesListDataSourceSchema
}

func (d *SamlServerProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SamlServerProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SamlServerProfilesListModel
	...
	packedList, diags := packSamlServerProfilesListFromSdk(ctx, listResponse.GetData())
