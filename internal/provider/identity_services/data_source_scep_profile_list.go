...
// ScepProfileListDataSource defines the data source implementation.
...
func (d *ScepProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ScepProfilesListDataSourceSchema
}

func (d *ScepProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ScepProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ScepProfilesListModel
	...
	packedList, diags := packScepProfilesListFromSdk(ctx, listResponse.GetData())
