...
// TacacsServerProfileListDataSource defines the data source implementation.
...
func (d *TacacsServerProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.TacacsServerProfilesListDataSourceSchema
}

func (d *TacacsServerProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *TacacsServerProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.TacacsServerProfilesListModel
	...
	packedList, diags := packTacacsServerProfilesListFromSdk(ctx, listResponse.GetData())
