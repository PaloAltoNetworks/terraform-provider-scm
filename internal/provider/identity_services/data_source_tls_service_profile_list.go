...
// TlsServiceProfileListDataSource defines the data source implementation.
type TlsServiceProfileListDataSource struct {
	client *identity_services.APIClient
}

func (d *TlsServiceProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_tls_service_profile_list"
}

func (d *TlsServiceProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.TlsServiceProfilesListDataSourceSchema
}

func (d *TlsServiceProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *TlsServiceProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.TlsServiceProfilesListModel
	...
	packedList, diags := packTlsServiceProfilesListFromSdk(ctx, listResponse.GetData())
