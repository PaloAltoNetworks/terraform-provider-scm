...
// radiusServerProfilesSensitiveValuePatcher is an in-memory struct to temporarily store plaintext
// and encrypted values for sensitive fields during the Create/Update/Read workflows.
type radiusServerProfilesSensitiveValuePatcher struct {
...
func (p *radiusServerProfilesSensitiveValuePatcher) init() {
...
func (p *radiusServerProfilesSensitiveValuePatcher) populatePatcherFromState(ctx context.Context, state models.RadiusServerProfiles) diag.Diagnostics {
...
func (p *radiusServerProfilesSensitiveValuePatcher) populateEncryptedValuesMap() map[string]string {
