...
var (
	_ datasource.DataSource              = &ForwardingProfileDestinationListDataSource{}
	_ datasource.DataSourceWithConfigure = &ForwardingProfileDestinationListDataSource{}
)

func NewForwardingProfileDestinationListDataSource() datasource.DataSource {
	return &ForwardingProfileDestinationListDataSource{}
}

// ForwardingProfileDestinationListDataSource defines the data source implementation.
type ForwardingProfileDestinationListDataSource struct {
...
func (d *ForwardingProfileDestinationListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ForwardingProfileDestinationsListDataSourceSchema
}

func (d *ForwardingProfileDestinationListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ForwardingProfileDestinationListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ForwardingProfileDestinationsListModel
	...
	packedList, diags := packForwardingProfileDestinationsListFromSdk(ctx, listResponse.GetData())
