...
var (
	_ datasource.DataSource              = &ForwardingProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &ForwardingProfileListDataSource{}
)

func NewForwardingProfileListDataSource() datasource.DataSource {
	return &ForwardingProfileListDataSource{}
}

// ForwardingProfileListDataSource defines the data source implementation.
type ForwardingProfileListDataSource struct {
	client *mobile_agent.APIClient
}

func (d *ForwardingProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_forwarding_profile_list"
}

func (d *ForwardingProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ForwardingProfilesListDataSourceSchema
}

func (d *ForwardingProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ForwardingProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ForwardingProfilesListModel
	...
	packedList, diags := packForwardingProfilesListFromSdk(ctx, listResponse.GetData())
