...
var (
	_ datasource.DataSource              = &ForwardingProfileRegionalAndCustomProxyListDataSource{}
	_ datasource.DataSourceWithConfigure = &ForwardingProfileRegionalAndCustomProxyListDataSource{}
)

func NewForwardingProfileRegionalAndCustomProxyListDataSource() datasource.DataSource {
	return &ForwardingProfileRegionalAndCustomProxyListDataSource{}
}

// ForwardingProfileRegionalAndCustomProxyListDataSource defines the data source implementation.
type ForwardingProfileRegionalAndCustomProxyListDataSource struct {
...
func (d *ForwardingProfileRegionalAndCustomProxyListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ForwardingProfileRegionalAndCustomProxiesListDataSourceSchema
}

func (d *ForwardingProfileRegionalAndCustomProxyListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ForwardingProfileRegionalAndCustomProxyListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ForwardingProfileRegionalAndCustomProxiesListModel
	...
	packedList, diags := packForwardingProfileRegionalAndCustomProxiesListFromSdk(ctx, listResponse.GetData())
