...
var (
	_ datasource.DataSource              = &ForwardingProfileSourceApplicationListDataSource{}
	_ datasource.DataSourceWithConfigure = &ForwardingProfileSourceApplicationListDataSource{}
)

func NewForwardingProfileSourceApplicationListDataSource() datasource.DataSource {
	return &ForwardingProfileSourceApplicationListDataSource{}
}

// ForwardingProfileSourceApplicationListDataSource defines the data source implementation.
type ForwardingProfileSourceApplicationListDataSource struct {
	client *mobile_agent.APIClient
}

func (d *ForwardingProfileSourceApplicationListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_forwarding_profile_source_application_list"
}

func (d *ForwardingProfileSourceApplicationListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ForwardingProfileSourceApplicationsListDataSourceSchema
}

func (d *ForwardingProfileSourceApplicationListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ForwardingProfileSourceApplicationListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ForwardingProfileSourceApplicationsListModel
	...
	packedList, diags := packForwardingProfileSourceApplicationsListFromSdk(ctx, listResponse.GetData())
