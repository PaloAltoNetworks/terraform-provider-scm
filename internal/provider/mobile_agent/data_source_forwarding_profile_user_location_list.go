...
var (
	_ datasource.DataSource              = &ForwardingProfileUserLocationListDataSource{}
	_ datasource.DataSourceWithConfigure = &ForwardingProfileUserLocationListDataSource{}
)

func NewForwardingProfileUserLocationListDataSource() datasource.DataSource {
	return &ForwardingProfileUserLocationListDataSource{}
}

// ForwardingProfileUserLocationListDataSource defines the data source implementation.
type ForwardingProfileUserLocationListDataSource struct {
	client *mobile_agent.APIClient
}

func (d *ForwardingProfileUserLocationListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_forwarding_profile_user_location_list"
}

func (d *ForwardingProfileUserLocationListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ForwardingProfileUserLocationsListDataSourceSchema
}

func (d *ForwardingProfileUserLocationListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ForwardingProfileUserLocationListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ForwardingProfileUserLocationsListModel
	...
	packedList, diags := packForwardingProfileUserLocationsListFromSdk(ctx, listResponse.GetData())
