...
// RESOURCE for SCM ForwardingProfileUserLocation (Package: mobile_agent)
var (
	_ resource.Resource                = &ForwardingProfileUserLocationResource{}
	_ resource.ResourceWithConfigure   = &ForwardingProfileUserLocationResource{}
	_ resource.ResourceWithImportState = &ForwardingProfileUserLocationResource{}
)

func NewForwardingProfileUserLocationResource() resource.Resource {
	return &ForwardingProfileUserLocationResource{}
}

// ForwardingProfileUserLocationResource defines the resource implementation.
type ForwardingProfileUserLocationResource struct {
	client *mobile_agent.APIClient
}

func (r *ForwardingProfileUserLocationResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "scm_forwarding_profile_user_location"
}

func (r *ForwardingProfileUserLocationResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.ForwardingProfileUserLocationsResourceSchema
}

func (r *ForwardingProfileUserLocationResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ForwardingProfileUserLocationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for ForwardingProfileUserLocation")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.ForwardingProfileUserLocations{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackForwardingProfileUserLocationsToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating forwarding_profile_user_locations on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.UserLocationsAPI.CreateGlobalProtectUserLocation(ctx).ForwardingProfileUserLocations(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating forwarding_profile_user_locations", err.Error())
	...
	packedObject, diags := packForwardingProfileUserLocationsFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created forwarding_profile_user_locations", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *ForwardingProfileUserLocationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.ForwardingProfileUserLocations - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for ForwardingProfileUserLocation")
	var data, savestate models.ForwardingProfileUserLocations
	...
	tflog.Debug(ctx, "Reading forwarding_profile_user_locations from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.UserLocationsAPI.GetGlobalProtectUserLocationByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no forwarding_profile_user_locations on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading forwarding_profile_user_locations", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packForwardingProfileUserLocationsFromSdk(ctx, *scmObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	savestateObject, diags := types.ObjectValueFrom(ctx, models.ForwardingProfileUserLocations{}.AttrTypes(), &savestate)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *ForwardingProfileUserLocationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.ForwardingProfileUserLocations which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for ForwardingProfileUserLocation")
	var plan, state models.ForwardingProfileUserLocations
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.ForwardingProfileUserLocations{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating forwarding_profile_user_locations on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.UserLocationsAPI.UpdateGlobalProtectUserLocationByID(ctx, objectId).ForwardingProfileUserLocations(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no forwarding_profile_user_locations on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating forwarding_profile_user_locations", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packForwardingProfileUserLocationsFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated forwarding_profile_user_locations", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *ForwardingProfileUserLocationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.ForwardingProfileUserLocations
	...
	tflog.Debug(ctx, "Deleting forwarding_profile_user_locations", map[string]interface{}{"id": objectId})
	deleteReq := r.client.UserLocationsAPI.DeleteGlobalProtectUserLocation(ctx, objectId)
	_, err := deleteReq.Execute()
	if err != nil {
		resp.Diagnostics.AddError("Error deleting forwarding_profile_user_locations", err.Error())
		detailedMessage := utils.PrintScmError(err)
		resp.Diagnostics.AddError(
...
func (r *ForwardingProfileUserLocationResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	if len(tokens) > 0 && tokens[0] != "" {
		...
		if folderValue == "Global" {
			resp.Diagnostics.AddError(
				"Invalid Folder Value in Import ID",
				"The folder value 'Global' is not allowed in import IDs. Please use 'All' instead.\nExample: terraform import scm_forwarding_profile_user_location.example \"All\":::\"<id>\"",
			)
			return
		}
