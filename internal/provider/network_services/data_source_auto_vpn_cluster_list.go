...
var (
	_ datasource.DataSource              = &AutoVpnClusterListDataSource{}
	_ datasource.DataSourceWithConfigure = &AutoVpnClusterListDataSource{}
)

func NewAutoVpnClusterListDataSource() datasource.DataSource {
	return &AutoVpnClusterListDataSource{}
}

// AutoVpnClusterListDataSource defines the data source implementation.
type AutoVpnClusterListDataSource struct {
...
func (d *AutoVpnClusterListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AutoVpnClustersListDataSourceSchema
}

func (d *AutoVpnClusterListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AutoVpnClusterListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AutoVpnClustersListModel
