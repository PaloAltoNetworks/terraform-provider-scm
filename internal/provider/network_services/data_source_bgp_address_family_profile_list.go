...
var (
	_ datasource.DataSource              = &BgpAddressFamilyProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &BgpAddressFamilyProfileListDataSource{}
)

func NewBgpAddressFamilyProfileListDataSource() datasource.DataSource {
	return &BgpAddressFamilyProfileListDataSource{}
}

// BgpAddressFamilyProfileListDataSource defines the data source implementation.
type BgpAddressFamilyProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *BgpAddressFamilyProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bgp_address_family_profile_list"
}

func (d *BgpAddressFamilyProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.BgpAddressFamilyProfilesListDataSourceSchema
}

func (d *BgpAddressFamilyProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BgpAddressFamilyProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.BgpAddressFamilyProfilesListModel
	...
	packedList, diags := packBgpAddressFamilyProfilesListFromSdk(ctx, listResponse.GetData())
