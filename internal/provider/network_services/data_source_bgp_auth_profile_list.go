...
var (
	_ datasource.DataSource              = &BgpAuthProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &BgpAuthProfileListDataSource{}
)

func NewBgpAuthProfileListDataSource() datasource.DataSource {
	return &BgpAuthProfileListDataSource{}
}

// BgpAuthProfileListDataSource defines the data source implementation.
type BgpAuthProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *BgpAuthProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bgp_auth_profile_list"
}

func (d *BgpAuthProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.BgpAuthProfilesListDataSourceSchema
}

func (d *BgpAuthProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BgpAuthProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.BgpAuthProfilesListModel
	...
	packedList, diags := packBgpAuthProfilesListFromSdk(ctx, listResponse.GetData())
