...
var (
	_ datasource.DataSource              = &BgpFilteringProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &BgpFilteringProfileListDataSource{}
)

func NewBgpFilteringProfileListDataSource() datasource.DataSource {
	return &BgpFilteringProfileListDataSource{}
}

// BgpFilteringProfileListDataSource defines the data source implementation.
type BgpFilteringProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *BgpFilteringProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bgp_filtering_profile_list"
}

func (d *BgpFilteringProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.BgpFilteringProfilesListDataSourceSchema
}

func (d *BgpFilteringProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BgpFilteringProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.BgpFilteringProfilesListModel
	...
	packedList, diags := packBgpFilteringProfilesListFromSdk(ctx, listResponse.GetData())
