...
var (
	_ datasource.DataSource              = &BgpRedistributionProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &BgpRedistributionProfileListDataSource{}
)

func NewBgpRedistributionProfileListDataSource() datasource.DataSource {
	return &BgpRedistributionProfileListDataSource{}
}

// BgpRedistributionProfileListDataSource defines the data source implementation.
type BgpRedistributionProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *BgpRedistributionProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bgp_redistribution_profile_list"
}

func (d *BgpRedistributionProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.BgpRedistributionProfilesListDataSourceSchema
}

func (d *BgpRedistributionProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BgpRedistributionProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.BgpRedistributionProfilesListModel
	...
	packedList, diags := packBgpRedistributionProfilesListFromSdk(ctx, listResponse.GetData())
