...
var (
	_ datasource.DataSource              = &BgpRouteMapListDataSource{}
	_ datasource.DataSourceWithConfigure = &BgpRouteMapListDataSource{}
)

func NewBgpRouteMapListDataSource() datasource.DataSource {
	return &BgpRouteMapListDataSource{}
}

// BgpRouteMapListDataSource defines the data source implementation.
type BgpRouteMapListDataSource struct {
	client *network_services.APIClient
}

func (d *BgpRouteMapListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bgp_route_map_list"
}

func (d *BgpRouteMapListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.BgpRouteMapsListDataSourceSchema
}

func (d *BgpRouteMapListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BgpRouteMapListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.BgpRouteMapsListModel
	...
	listReq := d.client.BGPRouteMapsAPI.ListBGPRouteMaps(ctx)
	...
	packedList, diags := packBgpRouteMapsListFromSdk(ctx, listResponse.GetData())
