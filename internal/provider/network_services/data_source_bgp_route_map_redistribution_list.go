...
var (
	_ datasource.DataSource              = &BgpRouteMapRedistributionListDataSource{}
	_ datasource.DataSourceWithConfigure = &BgpRouteMapRedistributionListDataSource{}
)

func NewBgpRouteMapRedistributionListDataSource() datasource.DataSource {
	return &BgpRouteMapRedistributionListDataSource{}
}

// BgpRouteMapRedistributionListDataSource defines the data source implementation.
type BgpRouteMapRedistributionListDataSource struct {
...
func (d *BgpRouteMapRedistributionListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.BgpRouteMapRedistributionsListDataSourceSchema
}

func (d *BgpRouteMapRedistributionListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BgpRouteMapRedistributionListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.BgpRouteMapRedistributionsListModel
	...
	packedList, diags := packBgpRouteMapRedistributionsListFromSdk(ctx, listResponse.GetData())
