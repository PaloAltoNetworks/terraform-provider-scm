...
var (
	_ datasource.DataSource              = &ConfigMatchListListDataSource{}
	_ datasource.DataSourceWithConfigure = &ConfigMatchListListDataSource{}
)

func NewConfigMatchListListDataSource() datasource.DataSource {
	return &ConfigMatchListListDataSource{}
}

// ConfigMatchListListDataSource defines the data source implementation.
type ConfigMatchListListDataSource struct {
...
func (d *ConfigMatchListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ConfigMatchListListDataSourceSchema
}

func (d *ConfigMatchListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ConfigMatchListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ConfigMatchListListModel
	...
	packedList, diags := packConfigMatchListListFromSdk(ctx, listResponse.GetData())
