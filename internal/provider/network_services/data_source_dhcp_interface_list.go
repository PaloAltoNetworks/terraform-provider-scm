...
var (
	_ datasource.DataSource              = &DhcpInterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &DhcpInterfaceListDataSource{}
)

func NewDhcpInterfaceListDataSource() datasource.DataSource {
	return &DhcpInterfaceListDataSource{}
}

// DhcpInterfaceListDataSource defines the data source implementation.
type DhcpInterfaceListDataSource struct {
...
func (d *DhcpInterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DhcpInterfacesListDataSourceSchema
}

func (d *DhcpInterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DhcpInterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DhcpInterfacesListModel
	...
	packedList, diags := packDhcpInterfacesListFromSdk(ctx, listResponse.GetData())
