...
var (
	_ datasource.DataSource              = &DnsProxyListDataSource{}
	_ datasource.DataSourceWithConfigure = &DnsProxyListDataSource{}
)

func NewDnsProxyListDataSource() datasource.DataSource {
	return &DnsProxyListDataSource{}
}

// DnsProxyListDataSource defines the data source implementation.
type DnsProxyListDataSource struct {
...
func (d *DnsProxyListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DnsProxiesListDataSourceSchema
}

func (d *DnsProxyListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DnsProxyListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DnsProxiesListModel
	...
	packedList, diags := packDnsProxiesListFromSdk(ctx, listResponse.GetData())
