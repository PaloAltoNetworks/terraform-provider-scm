...
var (
	_ datasource.DataSource              = &EthernetInterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &EthernetInterfaceListDataSource{}
)

func NewEthernetInterfaceListDataSource() datasource.DataSource {
	return &EthernetInterfaceListDataSource{}
}

// EthernetInterfaceListDataSource defines the data source implementation.
type EthernetInterfaceListDataSource struct {
...
func (d *EthernetInterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.EthernetInterfacesListDataSourceSchema
}

func (d *EthernetInterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *EthernetInterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.EthernetInterfacesListModel
	...
	packedList, diags := packEthernetInterfacesListFromSdk(ctx, listResponse.GetData())
