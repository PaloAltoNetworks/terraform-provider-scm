...
var (
	_ datasource.DataSource              = &GlobalprotectMatchListListDataSource{}
	_ datasource.DataSourceWithConfigure = &GlobalprotectMatchListListDataSource{}
)

func NewGlobalprotectMatchListListDataSource() datasource.DataSource {
	return &GlobalprotectMatchListListDataSource{}
}

// GlobalprotectMatchListListDataSource defines the data source implementation.
type GlobalprotectMatchListListDataSource struct {
...
func (d *GlobalprotectMatchListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.GlobalprotectMatchListListDataSourceSchema
}

func (d *GlobalprotectMatchListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *GlobalprotectMatchListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.GlobalprotectMatchListListModel
	...
	packedList, diags := packGlobalprotectMatchListListFromSdk(ctx, listResponse.GetData())
