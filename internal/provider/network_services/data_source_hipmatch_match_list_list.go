...
var (
	_ datasource.DataSource              = &HipmatchMatchListListDataSource{}
	_ datasource.DataSourceWithConfigure = &HipmatchMatchListListDataSource{}
)

func NewHipmatchMatchListListDataSource() datasource.DataSource {
	return &HipmatchMatchListListDataSource{}
}

// HipmatchMatchListListDataSource defines the data source implementation.
type HipmatchMatchListListDataSource struct {
	client *network_services.APIClient
}

func (d *HipmatchMatchListListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_hipmatch_match_list_list"
}

func (d *HipmatchMatchListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.HipmatchMatchListListDataSourceSchema
}

func (d *HipmatchMatchListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *HipmatchMatchListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.HipmatchMatchListListModel
	...
	packedList, diags := packHipmatchMatchListListFromSdk(ctx, listResponse.GetData())
