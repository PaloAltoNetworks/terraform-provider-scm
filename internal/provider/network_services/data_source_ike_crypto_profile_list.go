...
// IkeCryptoProfileListDataSource defines the data source implementation.
...
func (d *IkeCryptoProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.IkeCryptoProfilesListDataSourceSchema
}

func (d *IkeCryptoProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IkeCryptoProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.IkeCryptoProfilesListModel
	...
	packedList, diags := packIkeCryptoProfilesListFromSdk(ctx, listResponse.GetData())
