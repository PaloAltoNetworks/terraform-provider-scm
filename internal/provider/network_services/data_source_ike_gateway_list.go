...
// IkeGatewayListDataSource defines the data source implementation.
...
func (d *IkeGatewayListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.IkeGatewaysListDataSourceSchema
}

func (d *IkeGatewayListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IkeGatewayListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.IkeGatewaysListModel
	...
	packedList, diags := packIkeGatewaysListFromSdk(ctx, listResponse.GetData())
