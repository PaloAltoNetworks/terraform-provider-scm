...
var (
	_ datasource.DataSource              = &InterfaceManagementProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &InterfaceManagementProfileListDataSource{}
)

func NewInterfaceManagementProfileListDataSource() datasource.DataSource {
	return &InterfaceManagementProfileListDataSource{}
}

// InterfaceManagementProfileListDataSource defines the data source implementation.
type InterfaceManagementProfileListDataSource struct {
...
func (d *InterfaceManagementProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.InterfaceManagementProfilesListDataSourceSchema
}

func (d *InterfaceManagementProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceManagementProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.InterfaceManagementProfilesListModel
	...
	packedList, diags := packInterfaceManagementProfilesListFromSdk(ctx, listResponse.GetData())
