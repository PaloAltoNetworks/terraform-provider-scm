...
// IpsecCryptoProfileListDataSource defines the data source implementation.
...
func (d *IpsecCryptoProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.IpsecCryptoProfilesListDataSourceSchema
}

func (d *IpsecCryptoProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IpsecCryptoProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.IpsecCryptoProfilesListModel
	...
	packedList, diags := packIpsecCryptoProfilesListFromSdk(ctx, listResponse.GetData())
