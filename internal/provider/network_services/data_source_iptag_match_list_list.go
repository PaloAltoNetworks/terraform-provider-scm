...
var (
	_ datasource.DataSource              = &IptagMatchListListDataSource{}
	_ datasource.DataSourceWithConfigure = &IptagMatchListListDataSource{}
)

func NewIptagMatchListListDataSource() datasource.DataSource {
	return &IptagMatchListListDataSource{}
}

// IptagMatchListListDataSource defines the data source implementation.
type IptagMatchListListDataSource struct {
...
func (d *IptagMatchListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.IptagMatchListListDataSourceSchema
}

func (d *IptagMatchListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IptagMatchListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.IptagMatchListListModel
	...
	packedList, diags := packIptagMatchListListFromSdk(ctx, listResponse.GetData())
