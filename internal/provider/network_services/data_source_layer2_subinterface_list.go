...
var (
	_ datasource.DataSource              = &Layer2SubinterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &Layer2SubinterfaceListDataSource{}
)

func NewLayer2SubinterfaceListDataSource() datasource.DataSource {
	return &Layer2SubinterfaceListDataSource{}
}

// Layer2SubinterfaceListDataSource defines the data source implementation.
type Layer2SubinterfaceListDataSource struct {
	client *network_services.APIClient
}

func (d *Layer2SubinterfaceListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_layer2_subinterface_list"
}

func (d *Layer2SubinterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.Layer2SubinterfacesListDataSourceSchema
}

func (d *Layer2SubinterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *Layer2SubinterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.Layer2SubinterfacesListModel
	...
	packedList, diags := packLayer2SubinterfacesListFromSdk(ctx, listResponse.GetData())
