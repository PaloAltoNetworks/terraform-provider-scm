...
var (
	_ datasource.DataSource              = &Layer3SubinterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &Layer3SubinterfaceListDataSource{}
)

func NewLayer3SubinterfaceListDataSource() datasource.DataSource {
	return &Layer3SubinterfaceListDataSource{}
}

// Layer3SubinterfaceListDataSource defines the data source implementation.
type Layer3SubinterfaceListDataSource struct {
...
func (d *Layer3SubinterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.Layer3SubinterfacesListDataSourceSchema
}

func (d *Layer3SubinterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *Layer3SubinterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.Layer3SubinterfacesListModel
	...
	packedList, diags := packLayer3SubinterfacesListFromSdk(ctx, listResponse.GetData())
