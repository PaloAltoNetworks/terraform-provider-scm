...
var (
	_ datasource.DataSource              = &LinkTagListDataSource{}
	_ datasource.DataSourceWithConfigure = &LinkTagListDataSource{}
)

func NewLinkTagListDataSource() datasource.DataSource {
	return &LinkTagListDataSource{}
}

// LinkTagListDataSource defines the data source implementation.
type LinkTagListDataSource struct {
...
func (d *LinkTagListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LinkTagsListDataSourceSchema
}

func (d *LinkTagListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LinkTagListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LinkTagsListModel
	...
	packedList, diags := packLinkTagsListFromSdk(ctx, listResponse.GetData())
