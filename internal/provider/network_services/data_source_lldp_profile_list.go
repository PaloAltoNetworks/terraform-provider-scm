...
var (
	_ datasource.DataSource              = &LldpProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &LldpProfileListDataSource{}
)

func NewLldpProfileListDataSource() datasource.DataSource {
	return &LldpProfileListDataSource{}
}

// LldpProfileListDataSource defines the data source implementation.
type LldpProfileListDataSource struct {
...
func (d *LldpProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LldpProfilesListDataSourceSchema
}

func (d *LldpProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LldpProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LldpProfilesListModel
	...
	packedList, diags := packLldpProfilesListFromSdk(ctx, listResponse.GetData())
