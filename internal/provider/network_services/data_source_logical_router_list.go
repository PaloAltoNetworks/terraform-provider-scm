...
var (
	_ datasource.DataSource              = &LogicalRouterListDataSource{}
	_ datasource.DataSourceWithConfigure = &LogicalRouterListDataSource{}
)

func NewLogicalRouterListDataSource() datasource.DataSource {
	return &LogicalRouterListDataSource{}
}

// LogicalRouterListDataSource defines the data source implementation.
type LogicalRouterListDataSource struct {
...
func (d *LogicalRouterListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LogicalRoutersListDataSourceSchema
}

func (d *LogicalRouterListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LogicalRouterListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LogicalRoutersListModel
	...
	packedList, diags := packLogicalRoutersListFromSdk(ctx, listResponse.GetData())
