...
var (
	_ datasource.DataSource              = &LoopbackInterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &LoopbackInterfaceListDataSource{}
)

func NewLoopbackInterfaceListDataSource() datasource.DataSource {
	return &LoopbackInterfaceListDataSource{}
}

// LoopbackInterfaceListDataSource defines the data source implementation.
type LoopbackInterfaceListDataSource struct {
	client *network_services.APIClient
}

func (d *LoopbackInterfaceListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_loopback_interface_list"
}

func (d *LoopbackInterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LoopbackInterfacesListDataSourceSchema
}

func (d *LoopbackInterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LoopbackInterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LoopbackInterfacesListModel
	...
	packedList, diags := packLoopbackInterfacesListFromSdk(ctx, listResponse.GetData())
