...
// NatRuleListDataSource defines the data source implementation.
...
func (d *NatRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.NatRulesListDataSourceSchema
}

func (d *NatRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *NatRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.NatRulesListModel
	...
	packedList, diags := packNatRulesListFromSdk(ctx, listResponse.GetData())
