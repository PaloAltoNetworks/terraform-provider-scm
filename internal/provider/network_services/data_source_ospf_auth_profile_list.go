...
var (
	_ datasource.DataSource              = &OspfAuthProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &OspfAuthProfileListDataSource{}
)

func NewOspfAuthProfileListDataSource() datasource.DataSource {
	return &OspfAuthProfileListDataSource{}
}

// OspfAuthProfileListDataSource defines the data source implementation.
type OspfAuthProfileListDataSource struct {
...
func (d *OspfAuthProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.OspfAuthProfilesListDataSourceSchema
}

func (d *OspfAuthProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *OspfAuthProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.OspfAuthProfilesListModel
	...
	packedList, diags := packOspfAuthProfilesListFromSdk(ctx, listResponse.GetData())
