...
var (
	_ datasource.DataSource              = &PbfRuleListDataSource{}
	_ datasource.DataSourceWithConfigure = &PbfRuleListDataSource{}
)

func NewPbfRuleListDataSource() datasource.DataSource {
	return &PbfRuleListDataSource{}
}

// PbfRuleListDataSource defines the data source implementation.
type PbfRuleListDataSource struct {
...
func (d *PbfRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.PbfRulesListDataSourceSchema
}

func (d *PbfRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *PbfRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.PbfRulesListModel
	...
	packedList, diags := packPbfRulesListFromSdk(ctx, listResponse.GetData())
