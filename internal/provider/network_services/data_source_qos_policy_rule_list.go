...
// QosPolicyRuleListDataSource defines the data source implementation.
...
func (d *QosPolicyRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.QosPolicyRulesListDataSourceSchema
}

func (d *QosPolicyRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *QosPolicyRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.QosPolicyRulesListModel
	...
	packedList, diags := packQosPolicyRulesListFromSdk(ctx, listResponse.GetData())
