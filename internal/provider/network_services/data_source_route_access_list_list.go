...
var (
	_ datasource.DataSource              = &RouteAccessListListDataSource{}
	_ datasource.DataSourceWithConfigure = &RouteAccessListListDataSource{}
)

func NewRouteAccessListListDataSource() datasource.DataSource {
	return &RouteAccessListListDataSource{}
}

// RouteAccessListListDataSource defines the data source implementation.
type RouteAccessListListDataSource struct {
...
func (d *RouteAccessListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RouteAccessListsListDataSourceSchema
}

func (d *RouteAccessListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RouteAccessListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RouteAccessListsListModel
	...
	packedList, diags := packRouteAccessListsListFromSdk(ctx, listResponse.GetData())
