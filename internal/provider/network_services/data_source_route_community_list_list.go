...
var (
	_ datasource.DataSource              = &RouteCommunityListListDataSource{}
	_ datasource.DataSourceWithConfigure = &RouteCommunityListListDataSource{}
)

func NewRouteCommunityListListDataSource() datasource.DataSource {
	return &RouteCommunityListListDataSource{}
}

// RouteCommunityListListDataSource defines the data source implementation.
type RouteCommunityListListDataSource struct {
	client *network_services.APIClient
}

func (d *RouteCommunityListListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_route_community_list_list"
}

func (d *RouteCommunityListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RouteCommunityListsListDataSourceSchema
}

func (d *RouteCommunityListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RouteCommunityListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RouteCommunityListsListModel
	...
	packedList, diags := packRouteCommunityListsListFromSdk(ctx, listResponse.GetData())
