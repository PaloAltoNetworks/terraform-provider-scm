...
var (
	_ datasource.DataSource              = &RoutePathAccessListListDataSource{}
	_ datasource.DataSourceWithConfigure = &RoutePathAccessListListDataSource{}
)

func NewRoutePathAccessListListDataSource() datasource.DataSource {
	return &RoutePathAccessListListDataSource{}
}

// RoutePathAccessListListDataSource defines the data source implementation.
type RoutePathAccessListListDataSource struct {
	client *network_services.APIClient
}

func (d *RoutePathAccessListListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_route_path_access_list_list"
}

func (d *RoutePathAccessListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RoutePathAccessListsListDataSourceSchema
}

func (d *RoutePathAccessListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RoutePathAccessListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RoutePathAccessListsListModel
	...
	packedList, diags := packRoutePathAccessListsListFromSdk(ctx, listResponse.GetData())
