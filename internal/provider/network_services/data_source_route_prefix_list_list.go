...
var (
	_ datasource.DataSource              = &RoutePrefixListListDataSource{}
	_ datasource.DataSourceWithConfigure = &RoutePrefixListListDataSource{}
)

func NewRoutePrefixListListDataSource() datasource.DataSource {
	return &RoutePrefixListListDataSource{}
}

// RoutePrefixListListDataSource defines the data source implementation.
type RoutePrefixListListDataSource struct {
	client *network_services.APIClient
}

func (d *RoutePrefixListListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_route_prefix_list_list"
}

func (d *RoutePrefixListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RoutePrefixListsListDataSourceSchema
}

func (d *RoutePrefixListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RoutePrefixListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RoutePrefixListsListModel
	...
	packedList, diags := packRoutePrefixListsListFromSdk(ctx, listResponse.GetData())
