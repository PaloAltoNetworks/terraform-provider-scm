...
var (
	_ datasource.DataSource              = &SdwanErrorCorrectionProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &SdwanErrorCorrectionProfileListDataSource{}
)

func NewSdwanErrorCorrectionProfileListDataSource() datasource.DataSource {
	return &SdwanErrorCorrectionProfileListDataSource{}
}

// SdwanErrorCorrectionProfileListDataSource defines the data source implementation.
type SdwanErrorCorrectionProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *SdwanErrorCorrectionProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sdwan_error_correction_profile_list"
}

func (d *SdwanErrorCorrectionProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SdwanErrorCorrectionProfilesListDataSourceSchema
}

func (d *SdwanErrorCorrectionProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SdwanErrorCorrectionProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SdwanErrorCorrectionProfilesListModel
	...
	packedList, diags := packSdwanErrorCorrectionProfilesListFromSdk(ctx, listResponse.GetData())
