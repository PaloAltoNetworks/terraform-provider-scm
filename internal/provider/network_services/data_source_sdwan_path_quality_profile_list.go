...
var (
	_ datasource.DataSource              = &SdwanPathQualityProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &SdwanPathQualityProfileListDataSource{}
)

func NewSdwanPathQualityProfileListDataSource() datasource.DataSource {
	return &SdwanPathQualityProfileListDataSource{}
}

// SdwanPathQualityProfileListDataSource defines the data source implementation.
type SdwanPathQualityProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *SdwanPathQualityProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sdwan_path_quality_profile_list"
}

func (d *SdwanPathQualityProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SdwanPathQualityProfilesListDataSourceSchema
}

func (d *SdwanPathQualityProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SdwanPathQualityProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SdwanPathQualityProfilesListModel
	...
	packedList, diags := packSdwanPathQualityProfilesListFromSdk(ctx, listResponse.GetData())
