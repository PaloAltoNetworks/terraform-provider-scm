...
var (
	_ datasource.DataSource              = &SdwanRuleListDataSource{}
	_ datasource.DataSourceWithConfigure = &SdwanRuleListDataSource{}
)

func NewSdwanRuleListDataSource() datasource.DataSource {
	return &SdwanRuleListDataSource{}
}

// SdwanRuleListDataSource defines the data source implementation.
type SdwanRuleListDataSource struct {
...
func (d *SdwanRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SdwanRulesListDataSourceSchema
}

func (d *SdwanRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SdwanRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SdwanRulesListModel
	...
	packedList, diags := packSdwanRulesListFromSdk(ctx, listResponse.GetData())
