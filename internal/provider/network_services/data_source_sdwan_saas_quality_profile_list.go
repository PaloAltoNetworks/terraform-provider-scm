...
var (
	_ datasource.DataSource              = &SdwanSaasQualityProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &SdwanSaasQualityProfileListDataSource{}
)

func NewSdwanSaasQualityProfileListDataSource() datasource.DataSource {
	return &SdwanSaasQualityProfileListDataSource{}
}

// SdwanSaasQualityProfileListDataSource defines the data source implementation.
type SdwanSaasQualityProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *SdwanSaasQualityProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sdwan_saas_quality_profile_list"
}

func (d *SdwanSaasQualityProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SdwanSaasQualityProfilesListDataSourceSchema
}

func (d *SdwanSaasQualityProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SdwanSaasQualityProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SdwanSaasQualityProfilesListModel
	...
	packedList, diags := packSdwanSaasQualityProfilesListFromSdk(ctx, listResponse.GetData())
