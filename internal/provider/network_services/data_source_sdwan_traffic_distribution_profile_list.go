...
var (
	_ datasource.DataSource              = &SdwanTrafficDistributionProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &SdwanTrafficDistributionProfileListDataSource{}
)

func NewSdwanTrafficDistributionProfileListDataSource() datasource.DataSource {
	return &SdwanTrafficDistributionProfileListDataSource{}
}

// SdwanTrafficDistributionProfileListDataSource defines the data source implementation.
type SdwanTrafficDistributionProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *SdwanTrafficDistributionProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sdwan_traffic_distribution_profile_list"
}

func (d *SdwanTrafficDistributionProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SdwanTrafficDistributionProfilesListDataSourceSchema
}

func (d *SdwanTrafficDistributionProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SdwanTrafficDistributionProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SdwanTrafficDistributionProfilesListModel
	...
	packedList, diags := packSdwanTrafficDistributionProfilesListFromSdk(ctx, listResponse.GetData())
