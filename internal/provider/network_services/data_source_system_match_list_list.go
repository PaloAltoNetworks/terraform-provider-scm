...
var (
	_ datasource.DataSource              = &SystemMatchListListDataSource{}
	_ datasource.DataSourceWithConfigure = &SystemMatchListListDataSource{}
)

func NewSystemMatchListListDataSource() datasource.DataSource {
	return &SystemMatchListListDataSource{}
}

// SystemMatchListListDataSource defines the data source implementation.
type SystemMatchListListDataSource struct {
...
func (d *SystemMatchListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SystemMatchListListDataSourceSchema
}

func (d *SystemMatchListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SystemMatchListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SystemMatchListListModel
	...
	packedList, diags := packSystemMatchListListFromSdk(ctx, listResponse.GetData())
