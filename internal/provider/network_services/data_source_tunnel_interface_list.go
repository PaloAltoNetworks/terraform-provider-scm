...
var (
	_ datasource.DataSource              = &TunnelInterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &TunnelInterfaceListDataSource{}
)

func NewTunnelInterfaceListDataSource() datasource.DataSource {
	return &TunnelInterfaceListDataSource{}
}

// TunnelInterfaceListDataSource defines the data source implementation.
type TunnelInterfaceListDataSource struct {
...
func (d *TunnelInterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.TunnelInterfacesListDataSourceSchema
}

func (d *TunnelInterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *TunnelInterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.TunnelInterfacesListModel
	...
	packedList, diags := packTunnelInterfacesListFromSdk(ctx, listResponse.GetData())
