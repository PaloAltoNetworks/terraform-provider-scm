...
var (
	_ datasource.DataSource              = &UseridMatchListListDataSource{}
	_ datasource.DataSourceWithConfigure = &UseridMatchListListDataSource{}
)

func NewUseridMatchListListDataSource() datasource.DataSource {
	return &UseridMatchListListDataSource{}
}

// UseridMatchListListDataSource defines the data source implementation.
type UseridMatchListListDataSource struct {
...
func (d *UseridMatchListListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.UseridMatchListListDataSourceSchema
}

func (d *UseridMatchListListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *UseridMatchListListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.UseridMatchListListModel
	...
	packedList, diags := packUseridMatchListListFromSdk(ctx, listResponse.GetData())
