...
var (
	_ datasource.DataSource              = &VlanInterfaceListDataSource{}
	_ datasource.DataSourceWithConfigure = &VlanInterfaceListDataSource{}
)

func NewVlanInterfaceListDataSource() datasource.DataSource {
	return &VlanInterfaceListDataSource{}
}

// VlanInterfaceListDataSource defines the data source implementation.
type VlanInterfaceListDataSource struct {
...
func (d *VlanInterfaceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.VlanInterfacesListDataSourceSchema
}

func (d *VlanInterfaceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *VlanInterfaceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.VlanInterfacesListModel
	...
	packedList, diags := packVlanInterfacesListFromSdk(ctx, listResponse.GetData())
