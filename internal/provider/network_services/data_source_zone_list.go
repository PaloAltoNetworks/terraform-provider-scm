...
var (
	_ datasource.DataSource              = &ZoneListDataSource{}
	_ datasource.DataSourceWithConfigure = &ZoneListDataSource{}
)

func NewZoneListDataSource() datasource.DataSource {
	return &ZoneListDataSource{}
}

// ZoneListDataSource defines the data source implementation.
type ZoneListDataSource struct {
...
func (d *ZoneListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ZonesListDataSourceSchema
}

func (d *ZoneListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ZoneListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ZonesListModel
	...
	packedList, diags := packZonesListFromSdk(ctx, listResponse.GetData())
