...
var (
	_ datasource.DataSource              = &ZoneProtectionProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &ZoneProtectionProfileListDataSource{}
)

func NewZoneProtectionProfileListDataSource() datasource.DataSource {
	return &ZoneProtectionProfileListDataSource{}
}

// ZoneProtectionProfileListDataSource defines the data source implementation.
type ZoneProtectionProfileListDataSource struct {
	client *network_services.APIClient
}

func (d *ZoneProtectionProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zone_protection_profile_list"
}

func (d *ZoneProtectionProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ZoneProtectionProfilesListDataSourceSchema
}

func (d *ZoneProtectionProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ZoneProtectionProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ZoneProtectionProfilesListModel
	...
	packedList, diags := packZoneProtectionProfilesListFromSdk(ctx, listResponse.GetData())
