...
// RESOURCE for SCM BgpRouteMapRedistribution (Package: network_services)
var (
	_ resource.Resource                = &BgpRouteMapRedistributionResource{}
	_ resource.ResourceWithConfigure   = &BgpRouteMapRedistributionResource{}
	_ resource.ResourceWithImportState = &BgpRouteMapRedistributionResource{}
)

func NewBgpRouteMapRedistributionResource() resource.Resource {
	return &BgpRouteMapRedistributionResource{}
}

// BgpRouteMapRedistributionResource defines the resource implementation.
type BgpRouteMapRedistributionResource struct {
	client *network_services.APIClient
}

func (r *BgpRouteMapRedistributionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "scm_bgp_route_map_redistribution"
}

func (r *BgpRouteMapRedistributionResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.BgpRouteMapRedistributionsResourceSchema
}

func (r *BgpRouteMapRedistributionResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *BgpRouteMapRedistributionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for BgpRouteMapRedistribution")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.BgpRouteMapRedistributions{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackBgpRouteMapRedistributionsToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating bgp_route_map_redistributions on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.BGPRouteMapRedistributionsAPI.CreateBGPRouteMapRedistributions(ctx).BgpRouteMapRedistributions(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating bgp_route_map_redistributions", err.Error())
	...
	packedObject, diags := packBgpRouteMapRedistributionsFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created bgp_route_map_redistributions", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *BgpRouteMapRedistributionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.BgpRouteMapRedistributions - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for BgpRouteMapRedistribution")
	var data, savestate models.BgpRouteMapRedistributions
	...
	tflog.Debug(ctx, "Reading bgp_route_map_redistributions from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.BGPRouteMapRedistributionsAPI.GetBGPRouteMapRedistributionsByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no bgp_route_map_redistributions on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading bgp_route_map_redistributions", err.Error())
			detailedMessage := utils.PrintScmError(err)
...
func (r *BgpRouteMapRedistributionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.BgpRouteMapRedistributions which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for BgpRouteMapRedistribution")
	var plan, state models.BgpRouteMapRedistributions
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.BgpRouteMapRedistributions{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating bgp_route_map_redistributions on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.BGPRouteMapRedistributionsAPI.UpdateBGPRouteMapRedistributionsByID(ctx, objectId).BgpRouteMapRedistributions(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no bgp_route_map_redistributions on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating bgp_route_map_redistributions", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packBgpRouteMapRedistributionsFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated bgp_route_map_redistributions", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *BgpRouteMapRedistributionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.BgpRouteMapRedistributions
	...
	tflog.Debug(ctx, "Deleting bgp_route_map_redistributions", map[string]interface{}{"id": objectId})
	deleteReq := r.client.BGPRouteMapRedistributionsAPI.DeleteBGPRouteMapRedistributionsByID(ctx, objectId)
	httpResp, err := deleteReq.Execute()
	if err != nil {
		resp.Diagnostics.AddError("Error deleting bgp_route_map_redistributions", err.Error())
		detailedMessage := utils.PrintScmError(err)
		resp.Diagnostics.AddError(
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.BGPRouteMapRedistributionsAPI.GetBGPRouteMapRedistributionsByID(ctx, objectId).Execute()
			if getErr != nil {
...
func (r *BgpRouteMapRedistributionResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
