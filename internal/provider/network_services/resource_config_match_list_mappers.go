...
// --- Unpacker for ConfigMatchList ---
func unpackConfigMatchListToSdk(ctx context.Context, obj types.Object) (*network_services.ConfigMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering unpack helper for models.ConfigMatchList", map[string]interface{}{"tf_object": obj})
	diags := diag.Diagnostics{}
	var model models.ConfigMatchList
	...
	var sdk network_services.ConfigMatchList
	...
	tflog.Debug(ctx, "Exiting unpack helper for models.ConfigMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return &sdk, diags

}

// --- Packer for ConfigMatchList ---
func packConfigMatchListFromSdk(ctx context.Context, sdk network_services.ConfigMatchList) (types.Object, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering pack helper for models.ConfigMatchList", map[string]interface{}{"sdk_struct": sdk})
	diags := diag.Diagnostics{}
	var model models.ConfigMatchList
	var d diag.Diagnostics
	// Handling Primitives
	...
	obj, d := types.ObjectValueFrom(ctx, models.ConfigMatchList{}.AttrTypes(), &model)
	tflog.Debug(ctx, "Final object to be returned from pack helper", map[string]interface{}{"object": obj})
	diags.Append(d...)
	tflog.Debug(ctx, "Exiting pack helper for models.ConfigMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return obj, diags

}

// --- List Unpacker for ConfigMatchList ---
func unpackConfigMatchListListToSdk(ctx context.Context, list types.List) ([]network_services.ConfigMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list unpack helper for models.ConfigMatchList")
	diags := diag.Diagnostics{}
	...
	ans := make([]network_services.ConfigMatchList, 0, len(data))
	for i, item := range data {
		tflog.Debug(ctx, "Unpacking item from list", map[string]interface{}{"index": i})
		obj, _ := types.ObjectValueFrom(ctx, models.ConfigMatchList{}.AttrTypes(), &item)
		unpacked, d := unpackConfigMatchListToSdk(ctx, obj)
		diags.Append(d...)
		if unpacked != nil {
			ans = append(ans, *unpacked)
		}
	}
	tflog.Debug(ctx, "Exiting list unpack helper for models.ConfigMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return ans, diags
}

// --- List Packer for ConfigMatchList ---
func packConfigMatchListListFromSdk(ctx context.Context, sdks []network_services.ConfigMatchList) (types.List, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list pack helper for models.ConfigMatchList")
	diags := diag.Diagnostics{}
	var data []models.ConfigMatchList
	...
	for i, sdk := range sdks {
		...
		var model models.ConfigMatchList
		obj, d := packConfigMatchListFromSdk(ctx, sdk)
		diags.Append(d...)
		if diags.HasError() {
			return basetypes.NewListNull(models.ConfigMatchList{}.AttrType()), diags
		}
		diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
		data = append(data, model)
	}
	tflog.Debug(ctx, "Exiting list pack helper for models.ConfigMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return basetypes.NewListValueFrom(ctx, models.ConfigMatchList{}.AttrType(), data)
}
