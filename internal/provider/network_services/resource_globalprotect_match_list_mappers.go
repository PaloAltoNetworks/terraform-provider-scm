...
// --- Unpacker for GlobalprotectMatchList ---
func unpackGlobalprotectMatchListToSdk(ctx context.Context, obj types.Object) (*network_services.GlobalprotectMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering unpack helper for models.GlobalprotectMatchList", map[string]interface{}{"tf_object": obj})
	diags := diag.Diagnostics{}
	var model models.GlobalprotectMatchList
	...
	var sdk network_services.GlobalprotectMatchList
	...
	tflog.Debug(ctx, "Exiting unpack helper for models.GlobalprotectMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return &sdk, diags

}

// --- Packer for GlobalprotectMatchList ---
func packGlobalprotectMatchListFromSdk(ctx context.Context, sdk network_services.GlobalprotectMatchList) (types.Object, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering pack helper for models.GlobalprotectMatchList", map[string]interface{}{"sdk_struct": sdk})
	diags := diag.Diagnostics{}
	var model models.GlobalprotectMatchList
	var d diag.Diagnostics
	// Handling Primitives
	...
	obj, d := types.ObjectValueFrom(ctx, models.GlobalprotectMatchList{}.AttrTypes(), &model)
	tflog.Debug(ctx, "Final object to be returned from pack helper", map[string]interface{}{"object": obj})
	diags.Append(d...)
	tflog.Debug(ctx, "Exiting pack helper for models.GlobalprotectMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return obj, diags

}

// --- List Unpacker for GlobalprotectMatchList ---
func unpackGlobalprotectMatchListListToSdk(ctx context.Context, list types.List) ([]network_services.GlobalprotectMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list unpack helper for models.GlobalprotectMatchList")
	diags := diag.Diagnostics{}
	...
	ans := make([]network_services.GlobalprotectMatchList, 0, len(data))
	for i, item := range data {
		tflog.Debug(ctx, "Unpacking item from list", map[string]interface{}{"index": i})
		obj, _ := types.ObjectValueFrom(ctx, models.GlobalprotectMatchList{}.AttrTypes(), &item)
		unpacked, d := unpackGlobalprotectMatchListToSdk(ctx, obj)
		diags.Append(d...)
		if unpacked != nil {
			ans = append(ans, *unpacked)
		}
	}
	tflog.Debug(ctx, "Exiting list unpack helper for models.GlobalprotectMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return ans, diags
}

// --- List Packer for GlobalprotectMatchList ---
func packGlobalprotectMatchListListFromSdk(ctx context.Context, sdks []network_services.GlobalprotectMatchList) (types.List, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list pack helper for models.GlobalprotectMatchList")
	diags := diag.Diagnostics{}
	var data []models.GlobalprotectMatchList
	...
	for i, sdk := range sdks {
		...
		var model models.GlobalprotectMatchList
		obj, d := packGlobalprotectMatchListFromSdk(ctx, sdk)
		diags.Append(d...)
		if diags.HasError() {
			return basetypes.NewListNull(models.GlobalprotectMatchList{}.AttrType()), diags
		}
		diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
		data = append(data, model)
	}
	tflog.Debug(ctx, "Exiting list pack helper for models.GlobalprotectMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return basetypes.NewListValueFrom(ctx, models.GlobalprotectMatchList{}.AttrType(), data)
}
