...
// --- Unpacker for HipmatchMatchList ---
func unpackHipmatchMatchListToSdk(ctx context.Context, obj types.Object) (*network_services.HipmatchMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering unpack helper for models.HipmatchMatchList", map[string]interface{}{"tf_object": obj})
	diags := diag.Diagnostics{}
	var model models.HipmatchMatchList
	...
	var sdk network_services.HipmatchMatchList
	...
	tflog.Debug(ctx, "Exiting unpack helper for models.HipmatchMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return &sdk, diags

}

// --- Packer for HipmatchMatchList ---
func packHipmatchMatchListFromSdk(ctx context.Context, sdk network_services.HipmatchMatchList) (types.Object, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering pack helper for models.HipmatchMatchList", map[string]interface{}{"sdk_struct": sdk})
	diags := diag.Diagnostics{}
	var model models.HipmatchMatchList
	var d diag.Diagnostics
	// Handling Primitives
	...
	obj, d := types.ObjectValueFrom(ctx, models.HipmatchMatchList{}.AttrTypes(), &model)
	tflog.Debug(ctx, "Final object to be returned from pack helper", map[string]interface{}{"object": obj})
	diags.Append(d...)
	tflog.Debug(ctx, "Exiting pack helper for models.HipmatchMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return obj, diags

}

// --- List Unpacker for HipmatchMatchList ---
func unpackHipmatchMatchListListToSdk(ctx context.Context, list types.List) ([]network_services.HipmatchMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list unpack helper for models.HipmatchMatchList")
	diags := diag.Diagnostics{}
	...
	ans := make([]network_services.HipmatchMatchList, 0, len(data))
	for i, item := range data {
		tflog.Debug(ctx, "Unpacking item from list", map[string]interface{}{"index": i})
		obj, _ := types.ObjectValueFrom(ctx, models.HipmatchMatchList{}.AttrTypes(), &item)
		unpacked, d := unpackHipmatchMatchListToSdk(ctx, obj)
		diags.Append(d...)
		if unpacked != nil {
			ans = append(ans, *unpacked)
		}
	}
	tflog.Debug(ctx, "Exiting list unpack helper for models.HipmatchMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return ans, diags
}

// --- List Packer for HipmatchMatchList ---
func packHipmatchMatchListListFromSdk(ctx context.Context, sdks []network_services.HipmatchMatchList) (types.List, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list pack helper for models.HipmatchMatchList")
	diags := diag.Diagnostics{}
	var data []models.HipmatchMatchList
	...
	for i, sdk := range sdks {
		...
		var model models.HipmatchMatchList
		obj, d := packHipmatchMatchListFromSdk(ctx, sdk)
		diags.Append(d...)
		if diags.HasError() {
			return basetypes.NewListNull(models.HipmatchMatchList{}.AttrType()), diags
		}
		diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
		data = append(data, model)
	}
	tflog.Debug(ctx, "Exiting list pack helper for models.HipmatchMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return basetypes.NewListValueFrom(ctx, models.HipmatchMatchList{}.AttrType(), data)
}
