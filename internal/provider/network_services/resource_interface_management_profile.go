...
// RESOURCE for SCM InterfaceManagementProfile (Package: network_services)
var (
...
// InterfaceManagementProfileResource defines the resource implementation.
...
func (r *InterfaceManagementProfileResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.InterfaceManagementProfilesResourceSchema
}
...
func (r *InterfaceManagementProfileResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for InterfaceManagementProfile")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.InterfaceManagementProfiles{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackInterfaceManagementProfilesToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating interface_management_profiles on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.InterfaceManagementProfilesAPI.CreateInterfaceManagementProfiles(ctx).InterfaceManagementProfiles(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating interface_management_profiles", err.Error())
	...
	packedObject, diags := packInterfaceManagementProfilesFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created interface_management_profiles", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *InterfaceManagementProfileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.InterfaceManagementProfiles - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for InterfaceManagementProfile")
	var data, savestate models.InterfaceManagementProfiles
	...
	tflog.Debug(ctx, "Reading interface_management_profiles from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.InterfaceManagementProfilesAPI.GetInterfaceManagementProfilesByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no interface_management_profiles on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading interface_management_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packInterfaceManagementProfilesFromSdk(ctx, *scmObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *InterfaceManagementProfileResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	// Step 1: Initialize a plan and state of type models.InterfaceManagementProfiles which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for InterfaceManagementProfile")
	var plan, state models.InterfaceManagementProfiles
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.InterfaceManagementProfiles{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating interface_management_profiles on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.InterfaceManagementProfilesAPI.UpdateInterfaceManagementProfilesByID(ctx, objectId).InterfaceManagementProfiles(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no interface_management_profiles on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating interface_management_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packInterfaceManagementProfilesFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated interface_management_profiles", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
...
func (r *InterfaceManagementProfileResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Debug(ctx, "Deleting interface_management_profiles", map[string]interface{}{"id": objectId})
	deleteReq := r.client.InterfaceManagementProfilesAPI.DeleteInterfaceManagementProfilesByID(ctx, objectId)
	httpResp, err := deleteReq.Execute()
	if err != nil {
		resp.Diagnostics.AddError("Error deleting interface_management_profiles", err.Error())
		detailedMessage := utils.PrintScmError(err)
		resp.Diagnostics.AddError(
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.InterfaceManagementProfilesAPI.GetInterfaceManagementProfilesByID(ctx, objectId).Execute()
			if getErr != nil {
