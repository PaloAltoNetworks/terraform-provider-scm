...
// RESOURCE for SCM Layer3Subinterface (Package: network_services)
var (
	_ resource.Resource                = &Layer3SubinterfaceResource{}
	_ resource.ResourceWithConfigure   = &Layer3SubinterfaceResource{}
	_ resource.ResourceWithImportState = &Layer3SubinterfaceResource{}
)

func NewLayer3SubinterfaceResource() resource.Resource {
	return &Layer3SubinterfaceResource{}
}

// Layer3SubinterfaceResource defines the resource implementation.
type Layer3SubinterfaceResource struct {
...
func (r *Layer3SubinterfaceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.Layer3SubinterfacesResourceSchema
}

func (r *Layer3SubinterfaceResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *Layer3SubinterfaceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for Layer3Subinterface")
	...
	unpackedScmObject, diags := unpackLayer3SubinterfacesToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating layer3_subinterfaces on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.Layer3SubinterfacesAPI.CreateLayer3Subinterfaces(ctx).Layer3Subinterfaces(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating layer3_subinterfaces", err.Error())
	...
	packedObject, diags := packLayer3SubinterfacesFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created layer3_subinterfaces", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *Layer3SubinterfaceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.Layer3Subinterfaces - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for Layer3Subinterface")
	var data, savestate models.Layer3Subinterfaces
	...
	tflog.Debug(ctx, "Reading layer3_subinterfaces from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.Layer3SubinterfacesAPI.GetLayer3SubinterfacesByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no layer3_subinterfaces on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading layer3_subinterfaces", err.Error())
			detailedMessage := utils.PrintScmError(err)
...
func (r *Layer3SubinterfaceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.Layer3Subinterfaces which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for Layer3Subinterface")
	var plan, state models.Layer3Subinterfaces
	...
	tflog.Debug(ctx, "Updating layer3_subinterfaces on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.Layer3SubinterfacesAPI.UpdateLayer3SubinterfacesByID(ctx, objectId).Layer3Subinterfaces(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no layer3_subinterfaces on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating layer3_subinterfaces", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packLayer3SubinterfacesFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated layer3_subinterfaces", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *Layer3SubinterfaceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.Layer3Subinterfaces
	...
	tflog.Debug(ctx, "Deleting layer3_subinterfaces", map[string]interface{}{"id": objectId})
	deleteReq := r.client.Layer3SubinterfacesAPI.DeleteLayer3SubinterfacesByID(ctx, objectId)
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.Layer3SubinterfacesAPI.GetLayer3SubinterfacesByID(ctx, objectId).Execute()
			if getErr != nil {
...
func (r *Layer3SubinterfaceResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
