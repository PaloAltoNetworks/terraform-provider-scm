...
// RESOURCE for SCM SdwanSaasQualityProfile (Package: network_services)
var (
	_ resource.Resource                = &SdwanSaasQualityProfileResource{}
	_ resource.ResourceWithConfigure   = &SdwanSaasQualityProfileResource{}
	_ resource.ResourceWithImportState = &SdwanSaasQualityProfileResource{}
)

func NewSdwanSaasQualityProfileResource() resource.Resource {
	return &SdwanSaasQualityProfileResource{}
}

// SdwanSaasQualityProfileResource defines the resource implementation.
type SdwanSaasQualityProfileResource struct {
	client *network_services.APIClient
}

func (r *SdwanSaasQualityProfileResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "scm_sdwan_saas_quality_profile"
}

func (r *SdwanSaasQualityProfileResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.SdwanSaasQualityProfilesResourceSchema
}

func (r *SdwanSaasQualityProfileResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *SdwanSaasQualityProfileResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for SdwanSaasQualityProfile")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.SdwanSaasQualityProfiles{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackSdwanSaasQualityProfilesToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating sdwan_saas_quality_profiles on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.SDWANSaaSQualityProfilesAPI.CreateSDWANSaaSQualityProfiles(ctx).SdwanSaasQualityProfiles(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating sdwan_saas_quality_profiles", err.Error())
	...
	packedObject, diags := packSdwanSaasQualityProfilesFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created sdwan_saas_quality_profiles", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *SdwanSaasQualityProfileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.SdwanSaasQualityProfiles - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for SdwanSaasQualityProfile")
	var data, savestate models.SdwanSaasQualityProfiles
	...
	tflog.Debug(ctx, "Reading sdwan_saas_quality_profiles from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.SDWANSaaSQualityProfilesAPI.GetSDWANSaaSQualityProfilesByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no sdwan_saas_quality_profiles on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading sdwan_saas_quality_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packSdwanSaasQualityProfilesFromSdk(ctx, *scmObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *SdwanSaasQualityProfileResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.SdwanSaasQualityProfiles which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for SdwanSaasQualityProfile")
	var plan, state models.SdwanSaasQualityProfiles
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.SdwanSaasQualityProfiles{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating sdwan_saas_quality_profiles on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.SDWANSaaSQualityProfilesAPI.UpdateSDWANSaaSQualityProfilesByID(ctx, objectId).SdwanSaasQualityProfiles(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no sdwan_saas_quality_profiles on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating sdwan_saas_quality_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packSdwanSaasQualityProfilesFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated sdwan_saas_quality_profiles", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *SdwanSaasQualityProfileResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.SdwanSaasQualityProfiles
	...
	tflog.Debug(ctx, "Deleting sdwan_saas_quality_profiles", map[string]interface{}{"id": objectId})
	deleteReq := r.client.SDWANSaaSQualityProfilesAPI.DeleteSDWANSaaSQualityProfilesByID(ctx, objectId)
	httpResp, err := deleteReq.Execute()
	if err != nil {
		resp.Diagnostics.AddError("Error deleting sdwan_saas_quality_profiles", err.Error())
		detailedMessage := utils.PrintScmError(err)
		resp.Diagnostics.AddError(
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.SDWANSaaSQualityProfilesAPI.GetSDWANSaaSQualityProfilesByID(ctx, objectId).Execute()
			if getErr != nil {
...
func (r *SdwanSaasQualityProfileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
