...
// RESOURCE for SCM SdwanTrafficDistributionProfile (Package: network_services)
var (
	_ resource.Resource                = &SdwanTrafficDistributionProfileResource{}
	_ resource.ResourceWithConfigure   = &SdwanTrafficDistributionProfileResource{}
	_ resource.ResourceWithImportState = &SdwanTrafficDistributionProfileResource{}
)

func NewSdwanTrafficDistributionProfileResource() resource.Resource {
	return &SdwanTrafficDistributionProfileResource{}
}

// SdwanTrafficDistributionProfileResource defines the resource implementation.
type SdwanTrafficDistributionProfileResource struct {
	client *network_services.APIClient
}

func (r *SdwanTrafficDistributionProfileResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "scm_sdwan_traffic_distribution_profile"
}

func (r *SdwanTrafficDistributionProfileResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.SdwanTrafficDistributionProfilesResourceSchema
}

func (r *SdwanTrafficDistributionProfileResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *SdwanTrafficDistributionProfileResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for SdwanTrafficDistributionProfile")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.SdwanTrafficDistributionProfiles{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackSdwanTrafficDistributionProfilesToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating sdwan_traffic_distribution_profiles on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.SDWANTrafficDistributionProfilesAPI.CreateSDWANTrafficDistributionProfiles(ctx).SdwanTrafficDistributionProfiles(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating sdwan_traffic_distribution_profiles", err.Error())
	...
	packedObject, diags := packSdwanTrafficDistributionProfilesFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created sdwan_traffic_distribution_profiles", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *SdwanTrafficDistributionProfileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.SdwanTrafficDistributionProfiles - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for SdwanTrafficDistributionProfile")
	var data, savestate models.SdwanTrafficDistributionProfiles
	...
	tflog.Debug(ctx, "Reading sdwan_traffic_distribution_profiles from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.SDWANTrafficDistributionProfilesAPI.GetSDWANTrafficDistributionProfilesByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no sdwan_traffic_distribution_profiles on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading sdwan_traffic_distribution_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packSdwanTrafficDistributionProfilesFromSdk(ctx, *scmObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *SdwanTrafficDistributionProfileResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.SdwanTrafficDistributionProfiles which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for SdwanTrafficDistributionProfile")
	var plan, state models.SdwanTrafficDistributionProfiles
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.SdwanTrafficDistributionProfiles{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating sdwan_traffic_distribution_profiles on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.SDWANTrafficDistributionProfilesAPI.UpdateSDWANTrafficDistributionProfilesByID(ctx, objectId).SdwanTrafficDistributionProfiles(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no sdwan_traffic_distribution_profiles on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating sdwan_traffic_distribution_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packSdwanTrafficDistributionProfilesFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated sdwan_traffic_distribution_profiles", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *SdwanTrafficDistributionProfileResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.SdwanTrafficDistributionProfiles
	...
	tflog.Debug(ctx, "Deleting sdwan_traffic_distribution_profiles", map[string]interface{}{"id": objectId})
	deleteReq := r.client.SDWANTrafficDistributionProfilesAPI.DeleteSDWANTrafficDistributionProfilesByID(ctx, objectId)
	httpResp, err := deleteReq.Execute()
	if err != nil {
		resp.Diagnostics.AddError("Error deleting sdwan_traffic_distribution_profiles", err.Error())
		detailedMessage := utils.PrintScmError(err)
		resp.Diagnostics.AddError(
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.SDWANTrafficDistributionProfilesAPI.GetSDWANTrafficDistributionProfilesByID(ctx, objectId).Execute()
			if getErr != nil {
...
func (r *SdwanTrafficDistributionProfileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	if len(tokens) > 0 && tokens[0] != "" {
		...
		if folderValue == "Global" {
			resp.Diagnostics.AddError(
				"Invalid Folder Value in Import ID",
				"The folder value 'Global' is not allowed in import IDs. Please use 'All' instead.\nExample: terraform import scm_sdwan_traffic_distribution_profile.example \"All\":::\"<id>\"",
			)
			return
		}
