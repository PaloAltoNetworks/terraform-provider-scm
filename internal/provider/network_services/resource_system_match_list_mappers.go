...
// --- Unpacker for SystemMatchList ---
func unpackSystemMatchListToSdk(ctx context.Context, obj types.Object) (*network_services.SystemMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering unpack helper for models.SystemMatchList", map[string]interface{}{"tf_object": obj})
	diags := diag.Diagnostics{}
	var model models.SystemMatchList
	...
	var sdk network_services.SystemMatchList
	...
	tflog.Debug(ctx, "Exiting unpack helper for models.SystemMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return &sdk, diags

}

// --- Packer for SystemMatchList ---
func packSystemMatchListFromSdk(ctx context.Context, sdk network_services.SystemMatchList) (types.Object, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering pack helper for models.SystemMatchList", map[string]interface{}{"sdk_struct": sdk})
	diags := diag.Diagnostics{}
	var model models.SystemMatchList
	var d diag.Diagnostics
	// Handling Primitives
	...
	obj, d := types.ObjectValueFrom(ctx, models.SystemMatchList{}.AttrTypes(), &model)
	tflog.Debug(ctx, "Final object to be returned from pack helper", map[string]interface{}{"object": obj})
	diags.Append(d...)
	tflog.Debug(ctx, "Exiting pack helper for models.SystemMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return obj, diags

}

// --- List Unpacker for SystemMatchList ---
func unpackSystemMatchListListToSdk(ctx context.Context, list types.List) ([]network_services.SystemMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list unpack helper for models.SystemMatchList")
	diags := diag.Diagnostics{}
	...
	ans := make([]network_services.SystemMatchList, 0, len(data))
	for i, item := range data {
		tflog.Debug(ctx, "Unpacking item from list", map[string]interface{}{"index": i})
		obj, _ := types.ObjectValueFrom(ctx, models.SystemMatchList{}.AttrTypes(), &item)
		unpacked, d := unpackSystemMatchListToSdk(ctx, obj)
		diags.Append(d...)
		if unpacked != nil {
			ans = append(ans, *unpacked)
		}
	}
	tflog.Debug(ctx, "Exiting list unpack helper for models.SystemMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return ans, diags
}

// --- List Packer for SystemMatchList ---
func packSystemMatchListListFromSdk(ctx context.Context, sdks []network_services.SystemMatchList) (types.List, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list pack helper for models.SystemMatchList")
	diags := diag.Diagnostics{}
	var data []models.SystemMatchList
	...
	for i, sdk := range sdks {
		...
		var model models.SystemMatchList
		obj, d := packSystemMatchListFromSdk(ctx, sdk)
		diags.Append(d...)
		if diags.HasError() {
			return basetypes.NewListNull(models.SystemMatchList{}.AttrType()), diags
		}
		diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
		data = append(data, model)
	}
	tflog.Debug(ctx, "Exiting list pack helper for models.SystemMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return basetypes.NewListValueFrom(ctx, models.SystemMatchList{}.AttrType(), data)
}
