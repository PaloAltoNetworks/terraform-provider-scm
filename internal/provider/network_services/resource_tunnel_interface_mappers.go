...
func unpackTunnelInterfacesIpv6ToSdk(ctx context.Context, obj types.Object) (*network_services.TunnelInterfacesIpv6, diag.Diagnostics) {
	...
	if !model.Address.IsNull() && !model.Address.IsUnknown() {
		...
		unpacked, d := unpackTunnelInterfacesIpv6AddressInnerListToSdk(ctx, model.Address)
		diags.Append(d...)
...
func packTunnelInterfacesIpv6FromSdk(ctx context.Context, sdk network_services.TunnelInterfacesIpv6) (types.Object, diag.Diagnostics) {
	...
	if sdk.Address != nil {
		...
		packed, d := packTunnelInterfacesIpv6AddressInnerListFromSdk(ctx, sdk.Address)
		diags.Append(d...)
		model.Address = packed
	} else {
		model.Address = basetypes.NewListNull(models.TunnelInterfacesIpv6AddressInner{}.AttrType())
	}
	// Handling Primitives
	// Standard primitive packing
	if sdk.Enabled != nil {
...
// --- Unpacker for TunnelInterfacesIpv6AddressInner ---
func unpackTunnelInterfacesIpv6AddressInnerToSdk(ctx context.Context, obj types.Object) (*network_services.TunnelInterfacesIpv6AddressInner, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering unpack helper for models.TunnelInterfacesIpv6AddressInner", map[string]interface{}{"tf_object": obj})
	diags := diag.Diagnostics{}
	var model models.TunnelInterfacesIpv6AddressInner
	diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
	if diags.HasError() {
		tflog.Error(ctx, "Error converting Terraform object to Go model", map[string]interface{}{"diags": diags})
		return nil, diags
	...
	var sdk network_services.TunnelInterfacesIpv6AddressInner
	var d diag.Diagnostics
	...
	tflog.Debug(ctx, "Exiting unpack helper for models.TunnelInterfacesIpv6AddressInner", map[string]interface{}{"has_errors": diags.HasError()})
	return &sdk, diags

}

// --- Packer for TunnelInterfacesIpv6AddressInner ---
func packTunnelInterfacesIpv6AddressInnerFromSdk(ctx context.Context, sdk network_services.TunnelInterfacesIpv6AddressInner) (types.Object, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering pack helper for models.TunnelInterfacesIpv6AddressInner", map[string]interface{}{"sdk_struct": sdk})
	diags := diag.Diagnostics{}
	var model models.TunnelInterfacesIpv6AddressInner
	var d diag.Diagnostics
	// Handling Objects
	...
	obj, d := types.ObjectValueFrom(ctx, models.TunnelInterfacesIpv6AddressInner{}.AttrTypes(), &model)
	tflog.Debug(ctx, "Final object to be returned from pack helper", map[string]interface{}{"object": obj})
	diags.Append(d...)
	tflog.Debug(ctx, "Exiting pack helper for models.TunnelInterfacesIpv6AddressInner", map[string]interface{}{"has_errors": diags.HasError()})
	return obj, diags

}

// --- List Unpacker for TunnelInterfacesIpv6AddressInner ---
func unpackTunnelInterfacesIpv6AddressInnerListToSdk(ctx context.Context, list types.List) ([]network_services.TunnelInterfacesIpv6AddressInner, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list unpack helper for models.TunnelInterfacesIpv6AddressInner")
	diags := diag.Diagnostics{}
	var data []models.TunnelInterfacesIpv6AddressInner
	diags.Append(list.ElementsAs(ctx, &data, false)...)
	if diags.HasError() {
		tflog.Error(ctx, "Error converting list elements to Go models", map[string]interface{}{"diags": diags})
		return nil, diags
	...
	ans := make([]network_services.TunnelInterfacesIpv6AddressInner, 0, len(data))
	for i, item := range data {
		tflog.Debug(ctx, "Unpacking item from list", map[string]interface{}{"index": i})
		obj, _ := types.ObjectValueFrom(ctx, models.TunnelInterfacesIpv6AddressInner{}.AttrTypes(), &item)
		unpacked, d := unpackTunnelInterfacesIpv6AddressInnerToSdk(ctx, obj)
		diags.Append(d...)
		if unpacked != nil {
			ans = append(ans, *unpacked)
		}
	}
	tflog.Debug(ctx, "Exiting list unpack helper for models.TunnelInterfacesIpv6AddressInner", map[string]interface{}{"has_errors": diags.HasError()})
	return ans, diags
}

// --- List Packer for TunnelInterfacesIpv6AddressInner ---
func packTunnelInterfacesIpv6AddressInnerListFromSdk(ctx context.Context, sdks []network_services.TunnelInterfacesIpv6AddressInner) (types.List, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list pack helper for models.TunnelInterfacesIpv6AddressInner")
	diags := diag.Diagnostics{}
	var data []models.TunnelInterfacesIpv6AddressInner
	...
	for i, sdk := range sdks {
		tflog.Debug(ctx, "Packing item to list", map[string]interface{}{"index": i})
		var model models.TunnelInterfacesIpv6AddressInner
		obj, d := packTunnelInterfacesIpv6AddressInnerFromSdk(ctx, sdk)
		diags.Append(d...)
		if diags.HasError() {
			return basetypes.NewListNull(models.TunnelInterfacesIpv6AddressInner{}.AttrType()), diags
		}
		diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
		data = append(data, model)
	}
	tflog.Debug(ctx, "Exiting list pack helper for models.TunnelInterfacesIpv6AddressInner", map[string]interface{}{"has_errors": diags.HasError()})
	return basetypes.NewListValueFrom(ctx, models.TunnelInterfacesIpv6AddressInner{}.AttrType(), data)
}
