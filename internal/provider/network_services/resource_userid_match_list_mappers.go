...
// --- Unpacker for UseridMatchList ---
func unpackUseridMatchListToSdk(ctx context.Context, obj types.Object) (*network_services.UseridMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering unpack helper for models.UseridMatchList", map[string]interface{}{"tf_object": obj})
	diags := diag.Diagnostics{}
	var model models.UseridMatchList
	...
	var sdk network_services.UseridMatchList
	...
	tflog.Debug(ctx, "Exiting unpack helper for models.UseridMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return &sdk, diags

}

// --- Packer for UseridMatchList ---
func packUseridMatchListFromSdk(ctx context.Context, sdk network_services.UseridMatchList) (types.Object, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering pack helper for models.UseridMatchList", map[string]interface{}{"sdk_struct": sdk})
	diags := diag.Diagnostics{}
	var model models.UseridMatchList
	var d diag.Diagnostics
	// Handling Primitives
	...
	obj, d := types.ObjectValueFrom(ctx, models.UseridMatchList{}.AttrTypes(), &model)
	tflog.Debug(ctx, "Final object to be returned from pack helper", map[string]interface{}{"object": obj})
	diags.Append(d...)
	tflog.Debug(ctx, "Exiting pack helper for models.UseridMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return obj, diags

}

// --- List Unpacker for UseridMatchList ---
func unpackUseridMatchListListToSdk(ctx context.Context, list types.List) ([]network_services.UseridMatchList, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list unpack helper for models.UseridMatchList")
	diags := diag.Diagnostics{}
	...
	ans := make([]network_services.UseridMatchList, 0, len(data))
	for i, item := range data {
		tflog.Debug(ctx, "Unpacking item from list", map[string]interface{}{"index": i})
		obj, _ := types.ObjectValueFrom(ctx, models.UseridMatchList{}.AttrTypes(), &item)
		unpacked, d := unpackUseridMatchListToSdk(ctx, obj)
		diags.Append(d...)
		if unpacked != nil {
			ans = append(ans, *unpacked)
		}
	}
	tflog.Debug(ctx, "Exiting list unpack helper for models.UseridMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return ans, diags
}

// --- List Packer for UseridMatchList ---
func packUseridMatchListListFromSdk(ctx context.Context, sdks []network_services.UseridMatchList) (types.List, diag.Diagnostics) {
	tflog.Debug(ctx, "Entering list pack helper for models.UseridMatchList")
	diags := diag.Diagnostics{}
	var data []models.UseridMatchList
	...
	for i, sdk := range sdks {
		...
		var model models.UseridMatchList
		obj, d := packUseridMatchListFromSdk(ctx, sdk)
		diags.Append(d...)
		if diags.HasError() {
			return basetypes.NewListNull(models.UseridMatchList{}.AttrType()), diags
		}
		diags.Append(obj.As(ctx, &model, basetypes.ObjectAsOptions{})...)
		data = append(data, model)
	}
	tflog.Debug(ctx, "Exiting list pack helper for models.UseridMatchList", map[string]interface{}{"has_errors": diags.HasError()})
	return basetypes.NewListValueFrom(ctx, models.UseridMatchList{}.AttrType(), data)
}
