...
// RESOURCE for SCM ZoneProtectionProfile (Package: network_services)
var (
...
// ZoneProtectionProfileResource defines the resource implementation.
type ZoneProtectionProfileResource struct {
	client *network_services.APIClient
}

func (r *ZoneProtectionProfileResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "scm_zone_protection_profile"
}

func (r *ZoneProtectionProfileResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.ZoneProtectionProfilesResourceSchema
}

func (r *ZoneProtectionProfileResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ZoneProtectionProfileResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for ZoneProtectionProfile")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.ZoneProtectionProfiles{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackZoneProtectionProfilesToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating zone_protection_profiles on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.ZoneProtectionProfilesAPI.CreateZoneProtectionProfiles(ctx).ZoneProtectionProfiles(*unpackedScmObject)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error creating zone_protection_profiles", err.Error())
	...
	packedObject, diags := packZoneProtectionProfilesFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created zone_protection_profiles", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *ZoneProtectionProfileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.ZoneProtectionProfiles - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for ZoneProtectionProfile")
	var data, savestate models.ZoneProtectionProfiles
	...
	tflog.Debug(ctx, "Reading zone_protection_profiles from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.ZoneProtectionProfilesAPI.GetZoneProtectionProfilesByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no zone_protection_profiles on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on read SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error reading zone_protection_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
...
func (r *ZoneProtectionProfileResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.ZoneProtectionProfiles which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for ZoneProtectionProfile")
	var plan, state models.ZoneProtectionProfiles
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.ZoneProtectionProfiles{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating zone_protection_profiles on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.ZoneProtectionProfilesAPI.UpdateZoneProtectionProfilesByID(ctx, objectId).ZoneProtectionProfiles(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no zone_protection_profiles on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
			tflog.Debug(ctx, "Got an exception on update SCM API. ", map[string]interface{}{"id": objectId})
			resp.Diagnostics.AddError("Error updating zone_protection_profiles", err.Error())
			detailedMessage := utils.PrintScmError(err)
	...
	packedObject, diags := packZoneProtectionProfilesFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated zone_protection_profiles", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *ZoneProtectionProfileResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.ZoneProtectionProfiles
	...
	tflog.Debug(ctx, "Deleting zone_protection_profiles", map[string]interface{}{"id": objectId})
	deleteReq := r.client.ZoneProtectionProfilesAPI.DeleteZoneProtectionProfilesByID(ctx, objectId)
	httpResp, err := deleteReq.Execute()
	if err != nil {
		resp.Diagnostics.AddError("Error deleting zone_protection_profiles", err.Error())
		detailedMessage := utils.PrintScmError(err)
		resp.Diagnostics.AddError(
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.ZoneProtectionProfilesAPI.GetZoneProtectionProfilesByID(ctx, objectId).Execute()
			if getErr != nil {
...
func (r *ZoneProtectionProfileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
