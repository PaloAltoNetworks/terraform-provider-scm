...
// AddressGroupListDataSource defines the data source implementation.
...
func (d *AddressGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AddressGroupsListDataSourceSchema
}

func (d *AddressGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AddressGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AddressGroupsListModel
	...
	packedList, diags := packAddressGroupsListFromSdk(ctx, listResponse.GetData())
