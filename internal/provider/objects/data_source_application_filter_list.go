...
// ApplicationFilterListDataSource defines the data source implementation.
type ApplicationFilterListDataSource struct {
	client *objects.APIClient
}

func (d *ApplicationFilterListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_application_filter_list"
}

func (d *ApplicationFilterListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ApplicationFiltersListDataSourceSchema
}

func (d *ApplicationFilterListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ApplicationFilterListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ApplicationFiltersListModel
	...
	packedList, diags := packApplicationFiltersListFromSdk(ctx, listResponse.GetData())
