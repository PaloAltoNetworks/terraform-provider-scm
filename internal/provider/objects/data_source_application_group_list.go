...
// ApplicationGroupListDataSource defines the data source implementation.
type ApplicationGroupListDataSource struct {
	client *objects.APIClient
}

func (d *ApplicationGroupListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_application_group_list"
}

func (d *ApplicationGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ApplicationGroupsListDataSourceSchema
}

func (d *ApplicationGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ApplicationGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ApplicationGroupsListModel
	...
	packedList, diags := packApplicationGroupsListFromSdk(ctx, listResponse.GetData())
