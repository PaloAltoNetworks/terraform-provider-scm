...
// ApplicationListDataSource defines the data source implementation.
...
func (d *ApplicationListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
