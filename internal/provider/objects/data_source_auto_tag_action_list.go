...
var (
	_ datasource.DataSource              = &AutoTagActionListDataSource{}
	_ datasource.DataSourceWithConfigure = &AutoTagActionListDataSource{}
)

func NewAutoTagActionListDataSource() datasource.DataSource {
	return &AutoTagActionListDataSource{}
}

// AutoTagActionListDataSource defines the data source implementation.
type AutoTagActionListDataSource struct {
	client *objects.APIClient
}

func (d *AutoTagActionListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_auto_tag_action_list"
}

func (d *AutoTagActionListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AutoTagActionsListDataSourceSchema
}

func (d *AutoTagActionListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AutoTagActionListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AutoTagActionsListModel
	...
	listReq := d.client.AutoTagActionsAPI.ListAuto-TagActions(ctx)
	...
	packedList, diags := packAutoTagActionsListFromSdk(ctx, listResponse.GetData())
