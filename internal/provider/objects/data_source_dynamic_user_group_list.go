...
// DynamicUserGroupListDataSource defines the data source implementation.
...
func (d *DynamicUserGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DynamicUserGroupsListDataSourceSchema
}

func (d *DynamicUserGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DynamicUserGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DynamicUserGroupsListModel
	...
	packedList, diags := packDynamicUserGroupsListFromSdk(ctx, listResponse.GetData())
