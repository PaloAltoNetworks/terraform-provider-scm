...
// HipObjectListDataSource defines the data source implementation.
...
func (d *HipObjectListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.HipObjectsListDataSourceSchema
}

func (d *HipObjectListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *HipObjectListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.HipObjectsListModel
	...
	packedList, diags := packHipObjectsListFromSdk(ctx, listResponse.GetData())
