...
// HipProfileListDataSource defines the data source implementation.
type HipProfileListDataSource struct {
	client *objects.APIClient
}

func (d *HipProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_hip_profile_list"
}

func (d *HipProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.HipProfilesListDataSourceSchema
}

func (d *HipProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *HipProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.HipProfilesListModel
	...
	packedList, diags := packHipProfilesListFromSdk(ctx, listResponse.GetData())
