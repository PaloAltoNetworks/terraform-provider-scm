...
var (
	_ datasource.DataSource              = &HttpServerProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &HttpServerProfileListDataSource{}
)

func NewHttpServerProfileListDataSource() datasource.DataSource {
	return &HttpServerProfileListDataSource{}
}

// HttpServerProfileListDataSource defines the data source implementation.
type HttpServerProfileListDataSource struct {
	client *objects.APIClient
}

func (d *HttpServerProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_http_server_profile_list"
}

func (d *HttpServerProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.HttpServerProfilesListDataSourceSchema
}

func (d *HttpServerProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *HttpServerProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.HttpServerProfilesListModel
	...
	packedList, diags := packHttpServerProfilesListFromSdk(ctx, listResponse.GetData())
