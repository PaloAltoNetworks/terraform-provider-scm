...
var (
	_ datasource.DataSource              = &LogForwardingProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &LogForwardingProfileListDataSource{}
)

func NewLogForwardingProfileListDataSource() datasource.DataSource {
	return &LogForwardingProfileListDataSource{}
}

// LogForwardingProfileListDataSource defines the data source implementation.
type LogForwardingProfileListDataSource struct {
...
func (d *LogForwardingProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.LogForwardingProfilesListDataSourceSchema
}

func (d *LogForwardingProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *LogForwardingProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.LogForwardingProfilesListModel
	...
	packedList, diags := packLogForwardingProfilesListFromSdk(ctx, listResponse.GetData())
