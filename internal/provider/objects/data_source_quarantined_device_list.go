...
var (
	_ datasource.DataSource              = &QuarantinedDeviceListDataSource{}
	_ datasource.DataSourceWithConfigure = &QuarantinedDeviceListDataSource{}
)

func NewQuarantinedDeviceListDataSource() datasource.DataSource {
	return &QuarantinedDeviceListDataSource{}
}

// QuarantinedDeviceListDataSource defines the data source implementation.
type QuarantinedDeviceListDataSource struct {
	client *objects.APIClient
}

func (d *QuarantinedDeviceListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_quarantined_device_list"
}

func (d *QuarantinedDeviceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.QuarantinedDevicesListDataSourceSchema
}

func (d *QuarantinedDeviceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *QuarantinedDeviceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.QuarantinedDevicesListModel
	...
	listReq := d.client.QuarantinedDevicesAPI.ListQuarantinedDevices(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing QuarantinedDevicess", fmt.Sprintf("Could not list QuarantinedDevicess: %s", err.Error()))
	...
	packedList, diags := packQuarantinedDevicesListFromSdk(ctx, listResponse.GetData())
