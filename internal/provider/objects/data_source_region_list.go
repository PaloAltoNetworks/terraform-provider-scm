...
// RegionListDataSource defines the data source implementation.
...
func (d *RegionListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.RegionsListDataSourceSchema
}

func (d *RegionListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RegionListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.RegionsListModel
	...
	packedList, diags := packRegionsListFromSdk(ctx, listResponse.GetData())
