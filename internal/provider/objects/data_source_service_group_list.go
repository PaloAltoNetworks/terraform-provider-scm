...
var (
	_ datasource.DataSource              = &ServiceGroupListDataSource{}
	_ datasource.DataSourceWithConfigure = &ServiceGroupListDataSource{}
)

func NewServiceGroupListDataSource() datasource.DataSource {
	return &ServiceGroupListDataSource{}
}

// ServiceGroupListDataSource defines the data source implementation.
type ServiceGroupListDataSource struct {
	client *objects.APIClient
}

func (d *ServiceGroupListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_service_group_list"
}

func (d *ServiceGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ServiceGroupsListDataSourceSchema
}

func (d *ServiceGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ServiceGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ServiceGroupsListModel
	...
	packedList, diags := packServiceGroupsListFromSdk(ctx, listResponse.GetData())
