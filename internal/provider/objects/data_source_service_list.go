...
// ServiceListDataSource defines the data source implementation.
type ServiceListDataSource struct {
	client *objects.APIClient
}

func (d *ServiceListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_service_list"
}

func (d *ServiceListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ServicesListDataSourceSchema
}

func (d *ServiceListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ServiceListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ServicesListModel
	...
	packedList, diags := packServicesListFromSdk(ctx, listResponse.GetData())
