...
var (
	_ datasource.DataSource              = &SyslogServerProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &SyslogServerProfileListDataSource{}
)

func NewSyslogServerProfileListDataSource() datasource.DataSource {
	return &SyslogServerProfileListDataSource{}
}

// SyslogServerProfileListDataSource defines the data source implementation.
type SyslogServerProfileListDataSource struct {
...
func (d *SyslogServerProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SyslogServerProfilesListDataSourceSchema
}

func (d *SyslogServerProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SyslogServerProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SyslogServerProfilesListModel
	...
	packedList, diags := packSyslogServerProfilesListFromSdk(ctx, listResponse.GetData())
