...
// RESOURCE for SCM Application (Package: objects)
var (
...
func (r *ApplicationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for Application")
	...
	createReq := r.client.ApplicationsAPI.CreateApplications(ctx).Applications(*unpackedScmObject)
...
func (r *ApplicationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	tflog.Debug(ctx, "Starting Read function for Application")
	...
	getReq := r.client.ApplicationsAPI.GetApplicationsByID(ctx, objectId)
...
func (r *ApplicationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Debug(ctx, "Starting Update function for Application")
	...
	updateReq := r.client.ApplicationsAPI.UpdateApplicationsByID(ctx, objectId).Applications(*unpackedScmObject)
...
func (r *ApplicationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	deleteReq := r.client.ApplicationsAPI.DeleteApplicationsByID(ctx, objectId)
