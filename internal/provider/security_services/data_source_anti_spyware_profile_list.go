...
// AntiSpywareProfileListDataSource defines the data source implementation.
type AntiSpywareProfileListDataSource struct {
	client *security_services.APIClient
}

func (d *AntiSpywareProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_anti_spyware_profile_list"
}

func (d *AntiSpywareProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AntiSpywareProfilesListDataSourceSchema
}

func (d *AntiSpywareProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AntiSpywareProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AntiSpywareProfilesListModel
	...
	packedList, diags := packAntiSpywareProfilesListFromSdk(ctx, listResponse.GetData())
