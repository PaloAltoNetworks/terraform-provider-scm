...
// AntiSpywareSignatureListDataSource defines the data source implementation.
...
func (d *AntiSpywareSignatureListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AntiSpywareSignaturesListDataSourceSchema
}

func (d *AntiSpywareSignatureListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AntiSpywareSignatureListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AntiSpywareSignaturesListModel
	...
	listReq := d.client.AntiSpywareSignaturesAPI.ListAntiSpywareSignatures(ctx)
	...
	packedList, diags := packAntiSpywareSignaturesListFromSdk(ctx, listResponse.GetData())
