...
// AppOverrideRuleListDataSource defines the data source implementation.
type AppOverrideRuleListDataSource struct {
	client *security_services.APIClient
}

func (d *AppOverrideRuleListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_app_override_rule_list"
}

func (d *AppOverrideRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.AppOverrideRulesListDataSourceSchema
}

func (d *AppOverrideRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AppOverrideRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.AppOverrideRulesListModel
	...
	packedList, diags := packAppOverrideRulesListFromSdk(ctx, listResponse.GetData())
