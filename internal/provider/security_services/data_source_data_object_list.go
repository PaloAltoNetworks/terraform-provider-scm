...
var (
	_ datasource.DataSource              = &DataObjectListDataSource{}
	_ datasource.DataSourceWithConfigure = &DataObjectListDataSource{}
)

func NewDataObjectListDataSource() datasource.DataSource {
	return &DataObjectListDataSource{}
}

// DataObjectListDataSource defines the data source implementation.
type DataObjectListDataSource struct {
...
func (d *DataObjectListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DataObjectsListDataSourceSchema
}

func (d *DataObjectListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DataObjectListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DataObjectsListModel
	...
	packedList, diags := packDataObjectsListFromSdk(ctx, listResponse.GetData())
