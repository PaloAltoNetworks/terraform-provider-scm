...
var (
	_ datasource.DataSource              = &DecryptionExclusionListDataSource{}
	_ datasource.DataSourceWithConfigure = &DecryptionExclusionListDataSource{}
)

func NewDecryptionExclusionListDataSource() datasource.DataSource {
	return &DecryptionExclusionListDataSource{}
}

// DecryptionExclusionListDataSource defines the data source implementation.
type DecryptionExclusionListDataSource struct {
...
func (d *DecryptionExclusionListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DecryptionExclusionsListDataSourceSchema
}

func (d *DecryptionExclusionListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DecryptionExclusionListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DecryptionExclusionsListModel
	...
	packedList, diags := packDecryptionExclusionsListFromSdk(ctx, listResponse.GetData())
