...
// DecryptionProfileListDataSource defines the data source implementation.
...
func (d *DecryptionProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DecryptionProfilesListDataSourceSchema
}

func (d *DecryptionProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DecryptionProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DecryptionProfilesListModel
	...
	packedList, diags := packDecryptionProfilesListFromSdk(ctx, listResponse.GetData())
