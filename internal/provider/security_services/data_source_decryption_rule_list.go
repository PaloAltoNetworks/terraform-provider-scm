...
// DecryptionRuleListDataSource defines the data source implementation.
type DecryptionRuleListDataSource struct {
	client *security_services.APIClient
}

func (d *DecryptionRuleListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_decryption_rule_list"
}

func (d *DecryptionRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DecryptionRulesListDataSourceSchema
}

func (d *DecryptionRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DecryptionRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DecryptionRulesListModel
	...
	packedList, diags := packDecryptionRulesListFromSdk(ctx, listResponse.GetData())
