...
// DnsSecurityProfileListDataSource defines the data source implementation.
...
func (d *DnsSecurityProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DnsSecurityProfilesListDataSourceSchema
}

func (d *DnsSecurityProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DnsSecurityProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DnsSecurityProfilesListModel
	...
	packedList, diags := packDnsSecurityProfilesListFromSdk(ctx, listResponse.GetData())
