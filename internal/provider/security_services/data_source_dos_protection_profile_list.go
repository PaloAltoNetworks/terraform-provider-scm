...
var (
	_ datasource.DataSource              = &DosProtectionProfileListDataSource{}
	_ datasource.DataSourceWithConfigure = &DosProtectionProfileListDataSource{}
)

func NewDosProtectionProfileListDataSource() datasource.DataSource {
	return &DosProtectionProfileListDataSource{}
}

// DosProtectionProfileListDataSource defines the data source implementation.
type DosProtectionProfileListDataSource struct {
	client *security_services.APIClient
}

func (d *DosProtectionProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_dos_protection_profile_list"
}

func (d *DosProtectionProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DosProtectionProfilesListDataSourceSchema
}

func (d *DosProtectionProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DosProtectionProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DosProtectionProfilesListModel
	...
	packedList, diags := packDosProtectionProfilesListFromSdk(ctx, listResponse.GetData())
