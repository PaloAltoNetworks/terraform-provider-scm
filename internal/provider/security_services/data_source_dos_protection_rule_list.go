...
var (
	_ datasource.DataSource              = &DosProtectionRuleListDataSource{}
	_ datasource.DataSourceWithConfigure = &DosProtectionRuleListDataSource{}
)

func NewDosProtectionRuleListDataSource() datasource.DataSource {
	return &DosProtectionRuleListDataSource{}
}

// DosProtectionRuleListDataSource defines the data source implementation.
type DosProtectionRuleListDataSource struct {
...
func (d *DosProtectionRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.DosProtectionRulesListDataSourceSchema
}

func (d *DosProtectionRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DosProtectionRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.DosProtectionRulesListModel
	...
	packedList, diags := packDosProtectionRulesListFromSdk(ctx, listResponse.GetData())
