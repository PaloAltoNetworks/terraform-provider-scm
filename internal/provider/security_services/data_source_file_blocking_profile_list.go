...
// FileBlockingProfileListDataSource defines the data source implementation.
type FileBlockingProfileListDataSource struct {
	client *security_services.APIClient
}

func (d *FileBlockingProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_file_blocking_profile_list"
}

func (d *FileBlockingProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.FileBlockingProfilesListDataSourceSchema
}

func (d *FileBlockingProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *FileBlockingProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.FileBlockingProfilesListModel
	...
	packedList, diags := packFileBlockingProfilesListFromSdk(ctx, listResponse.GetData())
