...
// HttpHeaderProfileListDataSource defines the data source implementation.
type HttpHeaderProfileListDataSource struct {
	client *security_services.APIClient
}

func (d *HttpHeaderProfileListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "scm_http_header_profile_list"
}

func (d *HttpHeaderProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.HttpHeaderProfilesListDataSourceSchema
}

func (d *HttpHeaderProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *HttpHeaderProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.HttpHeaderProfilesListModel
	...
	packedList, diags := packHttpHeaderProfilesListFromSdk(ctx, listResponse.GetData())
