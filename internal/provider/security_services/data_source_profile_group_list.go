...
// ProfileGroupListDataSource defines the data source implementation.
...
func (d *ProfileGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ProfileGroupsListDataSourceSchema
}

func (d *ProfileGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ProfileGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ProfileGroupsListModel
	...
	packedList, diags := packProfileGroupsListFromSdk(ctx, listResponse.GetData())
