...
// SecurityRuleListDataSource defines the data source implementation.
...
func (d *SecurityRuleListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.SecurityRulesListDataSourceSchema
}

func (d *SecurityRuleListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *SecurityRuleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.SecurityRulesListModel
	...
	packedList, diags := packSecurityRulesListFromSdk(ctx, listResponse.GetData())
