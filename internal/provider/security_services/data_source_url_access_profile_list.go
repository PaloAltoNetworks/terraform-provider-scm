...
// UrlAccessProfileListDataSource defines the data source implementation.
...
func (d *UrlAccessProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.UrlAccessProfilesListDataSourceSchema
}

func (d *UrlAccessProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *UrlAccessProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.UrlAccessProfilesListModel
	...
	packedList, diags := packUrlAccessProfilesListFromSdk(ctx, listResponse.GetData())
