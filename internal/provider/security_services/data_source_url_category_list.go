...
// UrlCategoryListDataSource defines the data source implementation.
type UrlCategoryListDataSource struct {
	client *security_services.APIClient
}

func (d *UrlCategoryListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_url_category_list"
}

func (d *UrlCategoryListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.UrlCategoriesListDataSourceSchema
}

func (d *UrlCategoryListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *UrlCategoryListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.UrlCategoriesListModel
	...
	packedList, diags := packUrlCategoriesListFromSdk(ctx, listResponse.GetData())
