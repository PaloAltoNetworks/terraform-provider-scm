...
// WildfireAntiVirusProfileListDataSource defines the data source implementation.
...
func (d *WildfireAntiVirusProfileListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.WildfireAntiVirusProfilesListDataSourceSchema
}

func (d *WildfireAntiVirusProfileListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *WildfireAntiVirusProfileListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.WildfireAntiVirusProfilesListModel
	...
	packedList, diags := packWildfireAntiVirusProfilesListFromSdk(ctx, listResponse.GetData())
