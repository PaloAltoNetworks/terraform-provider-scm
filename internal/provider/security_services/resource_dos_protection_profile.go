...
// DosProtectionProfileResource defines the resource implementation.
type DosProtectionProfileResource struct {
	client *security_services.APIClient
}

func (r *DosProtectionProfileResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "scm_dos_protection_profile"
}

func (r *DosProtectionProfileResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = models.DosProtectionProfilesResourceSchema
}

func (r *DosProtectionProfileResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *DosProtectionProfileResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Starting Create function for DosProtectionProfile")
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.DosProtectionProfiles{}.AttrTypes(), &data)
	...
	unpackedScmObject, diags := unpackDosProtectionProfilesToSdk(ctx, planObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}

	tflog.Debug(ctx, "Creating dos_protection_profiles on SCM API")

	// 3. Initiate the API request with the body.
	createReq := r.client.DoSProtectionProfilesAPI.CreateDoSProtectionProfiles(ctx).DosProtectionProfiles(*unpackedScmObject)
	...
	packedObject, diags := packDosProtectionProfilesFromSdk(ctx, *createdObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Created dos_protection_profiles", map[string]interface{}{"tfid": data.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *DosProtectionProfileResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Step 1 - Initialize a data and savestate of type models.DosProtectionProfiles - which is the TF schema struct
	tflog.Debug(ctx, "Starting Read function for DosProtectionProfile")
	var data, savestate models.DosProtectionProfiles
	...
	tflog.Debug(ctx, "Reading dos_protection_profiles from SCM API", map[string]interface{}{"id": objectId})
	getReq := r.client.DoSProtectionProfilesAPI.GetDoSProtectionProfilesByID(ctx, objectId)
	scmObject, httpErr, err := getReq.Execute()
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no dos_protection_profiles on read SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
	...
	packedObject, diags := packDosProtectionProfilesFromSdk(ctx, *scmObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *DosProtectionProfileResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {

	// Step 1: Initialize a plan and state of type models.DosProtectionProfiles which is the terraform schema struct
	tflog.Debug(ctx, "Starting Update function for DosProtectionProfile")
	var plan, state models.DosProtectionProfiles
	...
	planObject, diags := types.ObjectValueFrom(ctx, models.DosProtectionProfiles{}.AttrTypes(), &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updating dos_protection_profiles on SCM API", map[string]interface{}{"id": objectId})
	updateReq := r.client.DoSProtectionProfilesAPI.UpdateDoSProtectionProfilesByID(ctx, objectId).DosProtectionProfiles(*unpackedScmObject)
	...
	if err != nil {
		if httpErr != nil && httpErr.StatusCode == http.StatusNotFound {
			tflog.Debug(ctx, "Got no dos_protection_profiles on update SCM API. Remove from state to let terraform create", map[string]interface{}{"id": objectId})
			resp.State.RemoveResource(ctx)
		} else {
	...
	packedObject, diags := packDosProtectionProfilesFromSdk(ctx, *updatedObject)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	...
	tflog.Debug(ctx, "Updated dos_protection_profiles", map[string]interface{}{"tfid": plan.Tfid.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}

func (r *DosProtectionProfileResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data models.DosProtectionProfiles
	...
	tflog.Debug(ctx, "Deleting dos_protection_profiles", map[string]interface{}{"id": objectId})
	deleteReq := r.client.DoSProtectionProfilesAPI.DeleteDoSProtectionProfilesByID(ctx, objectId)
	...
	if httpResp != nil && httpResp.StatusCode == http.StatusAccepted {
		...
		for time.Now().Before(deadline) {
			...
			_, getResp, getErr := r.client.DoSProtectionProfilesAPI.GetDoSProtectionProfilesByID(ctx, objectId).Execute()
			if getErr != nil {
...
func (r *DosProtectionProfileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
