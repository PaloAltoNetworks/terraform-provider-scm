...
var (
	_ datasource.DataSource              = &ConnectorGroupListDataSource{}
	_ datasource.DataSourceWithConfigure = &ConnectorGroupListDataSource{}
)

func NewConnectorGroupListDataSource() datasource.DataSource {
	return &ConnectorGroupListDataSource{}
}

// ConnectorGroupListDataSource defines the data source implementation.
type ConnectorGroupListDataSource struct {
	client *ztna_connector_all.APIClient
}

func (d *ConnectorGroupListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "ztna_connector_group_list"
}

func (d *ConnectorGroupListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ConnectorGroupsListDataSourceSchema
}

func (d *ConnectorGroupListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ConnectorGroupListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ConnectorGroupsListModel
	...
	listReq := d.client.ConnectorGroupAPI.ListConnectorGroups(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing ConnectorGroupss", fmt.Sprintf("Could not list ConnectorGroupss: %s", err.Error()))
	...
	packedList, diags := packConnectorGroupsListFromSdk(ctx, listResponse.GetData())
