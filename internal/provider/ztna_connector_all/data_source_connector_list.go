...
var (
	_ datasource.DataSource              = &ConnectorListDataSource{}
	_ datasource.DataSourceWithConfigure = &ConnectorListDataSource{}
)

func NewConnectorListDataSource() datasource.DataSource {
	return &ConnectorListDataSource{}
}

// ConnectorListDataSource defines the data source implementation.
type ConnectorListDataSource struct {
	client *ztna_connector_all.APIClient
}

func (d *ConnectorListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "ztna_connector_list"
}

func (d *ConnectorListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ConnectorsListDataSourceSchema
}

func (d *ConnectorListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ConnectorListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ConnectorsListModel
	...
	listReq := d.client.ConnectorAPI.ListConnectors(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing Connectorss", fmt.Sprintf("Could not list Connectorss: %s", err.Error()))
	...
	packedList, diags := packConnectorsListFromSdk(ctx, listResponse.GetData())
