...
var (
	_ datasource.DataSource              = &FqdnApplicationListDataSource{}
	_ datasource.DataSourceWithConfigure = &FqdnApplicationListDataSource{}
)

func NewFqdnApplicationListDataSource() datasource.DataSource {
	return &FqdnApplicationListDataSource{}
}

// FqdnApplicationListDataSource defines the data source implementation.
type FqdnApplicationListDataSource struct {
	client *ztna_connector_all.APIClient
}

func (d *FqdnApplicationListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "ztna_fqdn_application_list"
}

func (d *FqdnApplicationListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.ApplicationsListDataSourceSchema
}

func (d *FqdnApplicationListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *FqdnApplicationListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.ApplicationsListModel
	...
	listReq := d.client.FQDNAPI.ListApplications(ctx)
	...
	packedList, diags := packApplicationsListFromSdk(ctx, listResponse.GetData())
