...
var (
	_ datasource.DataSource              = &WildcardListDataSource{}
	_ datasource.DataSourceWithConfigure = &WildcardListDataSource{}
)

func NewWildcardListDataSource() datasource.DataSource {
	return &WildcardListDataSource{}
}

// WildcardListDataSource defines the data source implementation.
type WildcardListDataSource struct {
	client *ztna_connector_all.APIClient
}

func (d *WildcardListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "ztna_wildcard_list"
}

func (d *WildcardListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = models.WildcardsListDataSourceSchema
}

func (d *WildcardListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *WildcardListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data models.WildcardsListModel
	...
	listReq := d.client.WildcardAPI.ListWildcards(ctx)
	...
	if err != nil {
		resp.Diagnostics.AddError("Error Listing Wildcardss", fmt.Sprintf("Could not list Wildcardss: %s", err.Error()))
	...
	packedList, diags := packWildcardsListFromSdk(ctx, listResponse.GetData())
